...
- Left: tiny-baseline (e\478\解释\model-capability-token-budget-stability\seeds\seed-1337\token-cap-12\ladder\rungs\max-iters-4\run\checkpoint.pt)
- Right: tiny-repeat (e\478\解释\model-capability-token-budget-stability\seeds\seed-1337\token-cap-12\ladder\rungs\max-iters-4\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
...
| --- | --- | --- | ---: | --- | --- |
| continuation-science | continuation | True | 0 | 研究的方式，因为e四研少好？格或少四s存 | 研究的方式，因为e四研少好？格或少四s存 |
