...
- Left: tiny-baseline (e\478\解释\model-capability-token-budget-stability\seeds\seed-2026\token-cap-4\ladder\rungs\max-iters-4\run\checkpoint.pt)
- Right: tiny-repeat (e\478\解释\model-capability-token-budget-stability\seeds\seed-2026\token-cap-4\ladder\rungs\max-iters-4\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
