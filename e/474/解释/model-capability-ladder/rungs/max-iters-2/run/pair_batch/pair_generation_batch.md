...
- Left: tiny-baseline (e\474\解释\model-capability-ladder\rungs\max-iters-2\run\checkpoint.pt)
- Right: tiny-repeat (e\474\解释\model-capability-ladder\rungs\max-iters-2\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
