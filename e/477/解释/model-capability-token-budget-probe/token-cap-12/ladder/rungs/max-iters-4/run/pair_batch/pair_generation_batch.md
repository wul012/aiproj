...
- Left: tiny-baseline (e\477\解释\model-capability-token-budget-probe\token-cap-12\ladder\rungs\max-iters-4\run\checkpoint.pt)
- Right: tiny-repeat (e\477\解释\model-capability-token-budget-probe\token-cap-12\ladder\rungs\max-iters-4\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
