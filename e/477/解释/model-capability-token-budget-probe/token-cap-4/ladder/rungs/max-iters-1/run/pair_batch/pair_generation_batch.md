...
- Left: tiny-baseline (e\477\解释\model-capability-token-budget-probe\token-cap-4\ladder\rungs\max-iters-1\run\checkpoint.pt)
- Right: tiny-repeat (e\477\解释\model-capability-token-budget-probe\token-cap-4\ladder\rungs\max-iters-1\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
