...
- Left: tiny-baseline (e\473\解释\baseline-candidate-eval-loop\tiny-scorecard-comparison-smoke\baseline\run\checkpoint.pt)
- Right: tiny-repeat (e\473\解释\baseline-candidate-eval-loop\tiny-scorecard-comparison-smoke\baseline\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
