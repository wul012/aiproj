...
- Generated: `2026-05-28T11:52:13Z`
- Scorecards: `2`
...
| --- | ---: | ---: | --- | --- | ---: | --- | ---: | --- | --- | --- |
| tiny-baseline | 81.67 (+0) | 38.67 (+0) | pass | pass | 0 (+0) | missing | 10 | continuation-science:35 | baseline | This run is the baseline for scorecard deltas. |
| tiny-candidate | 81.67 (+0) | 38.67 (+0) | pass | pass | 0 (+0) | missing | 10 | continuation-science:35 | tied | Overall score changed +0 from tiny-baseline. Rubric average changed +0. Generation-quality flags changed +0. |
