...
- Generated: `2026-05-28T11:52:14Z`
- Decision: `blocked`
...
- Threshold closest: `tiny-candidate` / `-21.33`
- Threshold largest gap: `tiny-candidate` / `-21.33`
...
| --- | --- | ---: | --- | --- | ---: | ---: | ---: | --- | --- | --- | --- |
| tiny-baseline | baseline | 38.67 | pass | pass | +0 | +0 | 0 | baseline run is not a promotion candidate; rubric_avg_score below 60.0 | baseline_candidate; threshold |  |  |
| tiny-candidate | blocked | 38.67 | pass | pass | +0 | +0 | 0 | rubric_avg_score below 60.0 | threshold |  |  |
