...
- Left: tiny-baseline (e\475\解释\model-capability-ladder-stability\seeds\seed-1337\rungs\max-iters-2\run\checkpoint.pt)
- Right: tiny-repeat (e\475\解释\model-capability-ladder-stability\seeds\seed-1337\rungs\max-iters-2\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
