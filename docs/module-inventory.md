...
| `research` | 37 | Versioned experiments around adaptation, decoding, interpretability, and training behavior. |
...
| Interpretability/behavior | `grok_*`, `induction_*`, `similarity*` | Research/evaluation boundary; keep reusable statistical helpers split from long experiment modules. |
