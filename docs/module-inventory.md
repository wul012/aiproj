...
| `promoted_training*` | 48 | Governance/training handoff boundary; keep decision/review contract facades, seed/handoff summary builders, receipt automation checks, receipt sections, contract/check rendering, seed/handoff CSV field and row models, seed/handoff HTML stats, CSV/report rendering, assurance rendering, and artifact rendering split by role. |
