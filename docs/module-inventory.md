...
| `promoted_training*` | 36 | Governance/training handoff boundary; keep decision review facade, seed review summary aggregation, receipt sections, assurance rendering, and artifact rendering split by role. |
