...
| `promoted_training*` | 40 | Governance/training handoff boundary; keep decision review facade, seed review summary aggregation, receipt automation checks, receipt sections, contract/check rendering, CSV/report rendering, assurance rendering, and artifact rendering split by role. |
