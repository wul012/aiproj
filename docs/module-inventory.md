...
| `promoted_training*` | 43 | Governance/training handoff boundary; keep decision review facade, seed/handoff summary builders, receipt automation checks, receipt sections, contract/check rendering, CSV row models, CSV/report rendering, assurance rendering, and artifact rendering split by role. |
