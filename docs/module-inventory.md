...
|---|---:|---|
| `governance` / capability chains | 1078 | Main source of package sprawl; mostly outer-layer evidence and decision flows. |
| `reports-governance` | 48 | Stable reports, cards, dashboards, registries, release summaries. |
| `research` | 49 | Versioned experiments around adaptation, decoding, interpretability, and training behavior. |
