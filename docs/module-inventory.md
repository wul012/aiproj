...
| `promoted_training*` | 39 | Governance/training handoff boundary; keep decision review facade, seed review summary aggregation, receipt automation checks, receipt sections, contract/report rendering, CSV/report rendering, assurance rendering, and artifact rendering split by role. |
