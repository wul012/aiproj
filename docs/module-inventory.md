...
| `promoted_training*` | 37 | Governance/training handoff boundary; keep decision review facade, seed review summary aggregation, receipt automation checks, receipt sections, assurance rendering, and artifact rendering split by role. |
