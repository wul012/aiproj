...
| `promoted_training*` | 35 | Governance/training handoff boundary; keep decision review facade, summary aggregation, receipt sections, assurance rendering, and artifact rendering split by role. |
