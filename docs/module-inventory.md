...
| `promoted_training*` | 38 | Governance/training handoff boundary; keep decision review facade, seed review summary aggregation, receipt automation checks, receipt sections, CSV/report rendering, assurance rendering, and artifact rendering split by role. |
