...
| `promoted_training*` | 42 | Governance/training handoff boundary; keep decision review facade, seed/handoff summary aggregation, receipt automation checks, receipt sections, contract/check rendering, CSV row models, CSV/report rendering, assurance rendering, and artifact rendering split by role. |
