...
本目录承接 v473-v1097 的 MiniGPT 模型能力、真实 tiny 训练对比、baseline/candidate 能力评估和 publication receipt 讲解。前一阶段 `代码讲解记录_训练治理阶段/` 保留 v303-v472 的训练治理、promoted seed、receipt contract 和 CI 回归治理讲解。

从 v1098 开始，新的模型治理、receipt/index/review/contract-check 和文档分流讲解写入同级目录 `代码讲解记录_模型治理阶段/`。本目录只做历史保留和必要修正，不再继续堆新版本。

## 写入规则

- 编号继续沿用全局序号，从 `487-v473-...` 开始。
- 旧的 `代码讲解记录_训练治理阶段/` 不迁移，只作为 v303-v472 历史阶段保留。
- 本目录已经过密，v1098 起不再继续写入新版本讲解。
...
1107-v1093-publication-receipt-index.md
 -> v1093 code explanation: index the v1091 lookup-only receipt and v1092 contract check as digest-backed downstream governance evidence.
...
1083-v1069-publication-receipt-index.md
 -> v1069 code explanation: index the v1067 receipt and v1068 contract check as digest-backed lookup evidence.
...
1075-v1061-publication-receipt-index.md
 -> v1061 code explanation: index the v1059 lookup-only receipt and v1060 contract check as digest-backed lookup evidence.
...
1067-v1053-publication-receipt-index.md
 -> v1053 code explanation: index the v1051 lookup-only receipt and v1052 contract check as digest-backed lookup evidence.
...
1061-v1047-publication-receipt-index-receipt-index-receipt-index-receipt-index-receipt-index-receipt-index-receipt-index-receipt-index-receipt-index-receipt.md
 -> v1047 code explanation: record the v1046 receipt index review as a downstream lookup-only receipt while keeping production promotion blocked.
...
1046-v1032-publication-receipt-index-receipt-index-receipt-index-receipt-index-receipt-index-receipt-check.md
 -> v1032 code explanation: contract-check the v1031 downstream lookup-only receipt by rebuilding it from the v1030 review.
...
1036-v1022-publication-receipt-index-receipt-index-receipt-index-review.md
 -> v1022 code explanation: review the v1021 digest-backed receipt index before recording the next lookup-only receipt.

1035-v1021-publication-receipt-index-receipt-index-receipt-index.md
 -> v1021 code explanation: index the v1019 lookup-only receipt and v1020 contract check into a digest-backed receipt index.
...
1027-v1013-publication-receipt-index-receipt-index-publication-index-receipt-index-receipt-index-receipt-index-receipt-index-receipt-index.md
 -> v1013 code explanation: index the v1011 lookup-only receipt and v1012 contract check into a digest-backed receipt index.
...
1022-v1008-publication-receipt-index-receipt-index-publication-index-receipt-index-receipt-index-receipt-index-receipt-check.md
 -> v1008 code explanation: contract-check the v1007 lookup-only receipt by rebuilding it from the recorded v1006 receipt-index review.

1021-v1007-publication-receipt-index-receipt-index-publication-index-receipt-index-receipt-index-receipt-index-receipt.md
 -> v1007 code explanation: record the v1006-reviewed receipt index as a lookup-only downstream receipt.

1020-v1006-publication-receipt-index-receipt-index-publication-index-receipt-index-receipt-index-receipt-index-review.md
 -> v1006 code explanation: review the v1005 lookup-only receipt index before recording the next downstream receipt.

1019-v1005-publication-receipt-index-receipt-index-publication-index-receipt-index-receipt-index-receipt-index.md
 -> v1005 code explanation: index the v1003 receipt and v1004 contract check into a lookup-only receipt index with digest-backed evidence.
...
1009-v995-publication-receipt-index-receipt-index-publication-index-receipt.md
 -> v995 code explanation: record a lookup-only downstream receipt for the v994-reviewed publication index while keeping promotion blocked.
...
992-v978-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt-packet-index-publication-receipt-packet-index-review.md
 -> v978 code explanation: review the v977 receipt packet index before lookup-only publication and shorten artifact filenames to avoid Windows path length risk.
...
987-v973-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt-packet-index-publication-receipt.md
 -> v973 code explanation: record a lookup-only downstream consumer receipt from the v972 index review while preserving blocked uses.
...
984-v970-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt-packet-index-publication-check.md
 -> v970 code explanation: rebuild the v969 lookup-only publication from its v968 review and verify the contract before downstream indexing.
...
981-v967-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt-packet-index.md
 -> v967 code explanation: package the receipt packet and its contract check into a lookup-only receipt packet index while keeping promotion blocked.

980-v966-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt-packet-check.md
 -> v966 code explanation: rebuild the receipt packet index publication receipt packet from its source review and verify stable lookup-only fields.
...
958-v944-randomized-holdout-publication-registry-downstream-consumer-index-review.md
 -> v944 code explanation: review the downstream consumer index, confirm source evidence still exists, and keep consumption lookup-only.
...
962-v948-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-review.md
 -> v948 code explanation: review the ack bundle with digest-aware evidence checks before lookup-only publication.
...
965-v951-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-index.md
 -> v951 code explanation: index the downstream consumer ack bundle publication and contract check into a lookup-only downstream review entry.

966-v952-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-index-review.md
 -> v952 code explanation: review the downstream consumer ack bundle publication index before recording a lookup-only receipt.

967-v953-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt.md
 -> v953 code explanation: record a lookup-only downstream receipt for the reviewed ack bundle publication index.

968-v954-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-review.md
 -> v954 code explanation: review the downstream publication receipt and approve only receipt-packet construction while keeping promotion blocked.
...
971-v957-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index.md
 -> v957 code explanation: combine the downstream publication receipt packet and its contract check into a lookup-only packet index.

972-v958-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-review.md
 -> v958 code explanation: review the downstream publication receipt packet index before lookup-only publication while keeping promotion blocked.
...
975-v961-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-index.md
 -> v961 code explanation: combine the receipt packet index publication and its contract check into a lookup-only index.

976-v962-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-index-review.md
 -> v962 code explanation: review the receipt packet index publication index before recording a lookup-only receipt while keeping promotion blocked.

977-v963-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt.md
 -> v963 code explanation: record a digest-backed lookup-only receipt for the reviewed receipt packet index publication index.

978-v964-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt-review.md
 -> v964 code explanation: review the digest-backed receipt before receipt-packet construction while keeping promotion blocked.

979-v965-randomized-holdout-publication-registry-downstream-consumer-ack-bundle-publication-receipt-packet-index-publication-receipt-packet.md
 -> v965 code explanation: build a digest-backed receipt packet with packet rows and source evidence rows for contract checking.
...
870-v856-route-promotion-bounded-objective-unassisted-repair-seed-revision-curriculum-patch-training-run.md
 -> v856 code explanation: train the no-anchor patched corpus into a real checkpoint while keeping capability gated behind replay.
...
824-v810-route-promotion-bounded-real-replay-repair-training-run.md
 -> v810 code explanation: train a bounded repair checkpoint from the v809 repair seed and record training evidence.
...
932-v918-randomized-holdout-candidate-promotion-packet.md
 -> v918 code explanation: package the randomized target-hidden suite, dry-run, real replay, and review evidence into a candidate promotion packet while keeping direct promotion blocked.
...
940-v926-randomized-holdout-acceptance-publication-packet-review.md
 -> v926 code explanation: review the randomized holdout acceptance publication packet for bounded downstream publication only.
...
956-v942-randomized-holdout-publication-registry-downstream-consumer-packet-check.md
 -> v942 code explanation: rebuild the downstream consumer packet from its source receipt review and compare stable lookup-only fields.
