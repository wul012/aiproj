...
Version 232 makes training portfolio comparison carry the best-scoring portfolio's maturity status into summary and recommendations. A high-scoring run with a review-level maturity narrative is now explicitly treated as review evidence before it becomes a clean baseline.
...
- Training portfolio comparison summary now records the best-scoring portfolio's maturity status.
- Recommendations warn before promoting a high-scoring portfolio when maturity narrative status is review-level.
- Adds a focused regression test for best score plus review maturity status.
- Keeps this as a behavior clarification, not a new report layer.
- Archived command-output evidence in `c/232`.
