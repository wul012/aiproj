...
Version 308 carries handoff batch CI-regression context into promotion indexes, so compare inputs exclude clean-required promotions whose handoff batch still contains CI-regressed evidence.
