...
Version 296 carries CI workflow order counts into CLI stdout and project audit context so smoke-before-coverage drift is visible outside the raw hygiene JSON.
