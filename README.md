...
Version 292 adds a GitHub Actions smoke step for promoted seed handoff assurance, so CI now runs the handoff, receipt-check, embedded receipt-check, and assurance chain before coverage.
