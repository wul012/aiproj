...
Version 313 upgrades promoted seed handoff automation receipts to schema v2, so CI-regression fields are not only written by the handoff but also validated by receipt and embedded sidecar checks.
