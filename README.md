...
Version 354 carries dataset snapshot deltas into run comparison, so loss and eval deltas can be read next to fingerprint, dedupe-policy, source-order, included/skipped source, and corpus-size changes.
