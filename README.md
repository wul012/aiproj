...
Version 311 carries promoted-decision CI-regression exclusion context into promoted next-cycle seeds, so the seed handoff preserves why rejected clean-required inputs stayed out of the baseline.
