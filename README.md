...
Version 278 adds a promoted seed handoff `automation_gate` that summarizes requested clean-evidence and clean batch-review requirements. Strict CLI runs now print both requirement diagnostics before exiting and persist passed/failed requirement lists in JSON, CSV, Markdown, and HTML.
