...
Version 326 adds a decision failure taxonomy, so benchmark scorecard decisions and tiny smokes can report blocker/review categories and dominant failure modes instead of only raw text.
