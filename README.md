...
Version 281 adds compact promoted seed handoff automation receipt artifacts, so CI and external scripts can read final decision, exit code, blocking source, and failed requirements without parsing the full handoff report.
