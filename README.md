...
Version 231 hardens the eval-readiness evidence chain with an integration test from scorecard comparison through promotion decision into maturity narrative review status. This raises testing discipline without adding another report layer.
...
- Adds `tests/test_eval_readiness_chain.py` as a cross-module integration test.
- Builds scorecard comparison from real scorecard JSON fixtures.
- Builds promotion decision from the generated comparison artifact.
- Builds maturity narrative from the generated decision and verifies portfolio review status.
- No new report layer or production behavior change; this version improves test discipline.
- Archived command-output evidence in `c/231`.
