...
Version 339 adds summary/check artifact digests to the CI tiny scorecard wrapper plan, so each wrapper invocation records hashes for the summary and summary-check sidecars it produced.
