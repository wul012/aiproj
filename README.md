...
Version 319 lifts benchmark scorecard decision diagnostics into the tiny comparison smoke summary, so blocked/review candidates, first blockers, and recommendations are visible without opening the decision JSON.
