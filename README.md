...
Version 238 adds Dependabot configuration for GitHub Actions and Python dependencies. The project now has a low-risk automated dependency-update entry point plus a small test that protects the config shape.
...
- Dependabot now tracks GitHub Actions updates weekly.
- Dependabot now tracks root Python `pip` dependency updates weekly.
- A small unittest protects the Dependabot config shape.
- Archived command-output evidence in `c/238`.
