...
Version 229 carries scorecard-comparison eval readiness into benchmark scorecard promotion decisions. Non-comparison-ready candidates now become review-level evidence rather than clean promotion evidence, while existing regression blockers remain unchanged.
...
- Scorecard decision candidate evaluations now carry eval-suite coverage and comparison readiness.
- Non-comparison-ready candidates become review-level evidence instead of clean promotion evidence.
- Summary records non-comparison-ready candidate count and names plus comparison-level readiness context.
- CSV, Markdown, and HTML decision artifacts expose eval comparison readiness.
- Recommendations warn when selected or compared scorecards are not comparison-ready.
- Archived command-output evidence in `c/229`.
