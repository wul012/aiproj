...
Version 235 adds maturity review portfolio names to training portfolio comparison summaries and human-facing outputs. Review counts now identify the affected portfolio(s), making the maturity guard easier to trace.
...
- Training portfolio comparison summary now records `maturity_review_names`.
- Markdown summary exposes the review portfolio names.
- HTML stats exposes the same review portfolio names.
- Tests cover both best-score review and non-leading review names.
- Archived command-output evidence in `c/235`.
