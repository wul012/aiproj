...
Version 183 splits module pressure scanning out of `maintenance_policy.py` into `maintenance_pressure.py`. The maintenance batching report, proposal decision logic, module-pressure report schema, script behavior, artifact writers, and legacy imports from `maintenance_policy.py` stay unchanged, while the policy module returns to batching/proposal governance.
...
| Training scale workflow | Training portfolio pipeline with extracted artifact writers, comparison artifact layer, batch matrix, scale planner with extracted artifact writers, gates, controlled handoff, run-decision artifact writers, consolidated workflow with extracted artifact writers, promotion with extracted artifact writers, promoted comparison artifact writers, promoted baseline/seed artifact writers, and promoted seed handoff artifact writers | `training_scale_plan.py`, `training_scale_plan_artifacts.py`, `training_scale_gate.py`, `training_scale_gate_artifacts.py`, `training_scale_workflow.py`, `training_scale_workflow_artifacts.py`, `training_scale_run_decision.py`, `training_scale_run_decision_artifacts.py`, `training_scale_promotion_artifacts.py`, `promoted_training_scale_comparison.py`, `promoted_training_scale_comparison_artifacts.py`, `promoted_training_scale_seed.py`, `promoted_training_scale_seed_artifacts.py`, `promoted_training_scale_seed_handoff.py`, `promoted_training_scale_seed_handoff_artifacts.py`, other training-scale modules/tests, and c/69-c/97/c122/c132/c160/c165/c168-c169/c173-c175/c180 archives | Move from dry-run/governance evidence toward real promoted training runs |
| Shared report infrastructure | `report_utils` backs the v83-v108 migration series; v109 adds maintenance batching; v110 adds module pressure scanning; v111-v136 split several high-pressure rendering, service, registry, dashboard, comparison, project-audit, release-gate, maturity, and generation-quality boundaries; v142 adds target-Python compatibility checks to source encoding hygiene; v143 tries the Node 24 runtime opt-in; v144 upgrades actions to Node 24 native versions; v145 turns that workflow policy into a runnable JSON/CSV/Markdown/HTML hygiene gate; v146 feeds CI workflow hygiene evidence into project audit; v147 carries it into release bundles; v148 surfaces it in release readiness dashboards; v149 compares it across readiness reports; v150 rolls it into registry tracking; v151 feeds it into maturity summary review context; v152 tightens CI workflow hygiene typing and action-tag parsing; v153 splits release bundle artifact rendering; v154 splits release readiness artifact rendering; v155 splits server log-event construction; v156 splits server checkpoint payloads; v157 splits registry leaderboard rendering; v158 splits release gate profile comparison artifacts; v159 splits server HTTP response/file helpers; v160 splits training scale promotion artifacts; v161 splits dataset card artifacts; v162 splits model card artifacts; v163 splits benchmark scorecard comparison deltas; v164 splits server request-history endpoints; v165 splits training scale plan artifacts; v166 splits project audit context checks; v167 splits playground request-history script; v168 splits promoted training scale seed artifacts; v169 splits promoted training scale seed handoff artifacts; v170 splits release readiness comparison artifacts; v171 splits server GET route dispatch; v172 splits eval suite artifact rendering; v173 splits training scale run decision artifact rendering; v174 splits training scale gate artifact rendering; v175 splits promoted training scale comparison artifact rendering; v176 splits benchmark scorecard decision artifact rendering; v177 splits dashboard section/helper rendering; v178 splits server POST route handling; v179 splits maturity narrative summary and section/evidence helpers; v180 splits training-scale workflow artifact rendering; v181 splits CI workflow hygiene artifact rendering; v182 splits benchmark scorecard comparison Markdown/HTML section rendering; v183 splits module-pressure scanning out of maintenance policy | `src/minigpt/report_utils.py`, `src/minigpt/dashboard.py`, `src/minigpt/dashboard_render.py`, `src/minigpt/dashboard_sections.py`, `src/minigpt/maturity.py`, `src/minigpt/maturity_artifacts.py`, `src/minigpt/maturity_narrative.py`, `src/minigpt/maturity_narrative_summary.py`, `src/minigpt/maturity_narrative_sections.py`, `src/minigpt/maturity_narrative_artifacts.py`, `src/minigpt/release_gate.py`, `src/minigpt/release_gate_artifacts.py`, `src/minigpt/release_gate_comparison.py`, `src/minigpt/release_gate_comparison_artifacts.py`, `src/minigpt/generation_quality.py`, `src/minigpt/generation_quality_artifacts.py`, `src/minigpt/comparison.py`, `src/minigpt/comparison_artifacts.py`, `src/minigpt/training_portfolio.py`, `src/minigpt/training_portfolio_artifacts.py`, `src/minigpt/training_portfolio_comparison.py`, `src/minigpt/training_portfolio_comparison_artifacts.py`, `src/minigpt/training_portfolio_batch.py`, `src/minigpt/training_portfolio_batch_artifacts.py`, `src/minigpt/training_scale_workflow_artifacts.py`, `src/minigpt/training_scale_plan_artifacts.py`, `src/minigpt/training_scale_gate_artifacts.py`, `src/minigpt/training_scale_run_decision_artifacts.py`, `src/minigpt/training_scale_promotion_artifacts.py`, `src/minigpt/promoted_training_scale_comparison_artifacts.py`, `src/minigpt/promoted_training_scale_seed_artifacts.py`, `src/minigpt/promoted_training_scale_seed_handoff_artifacts.py`, `src/minigpt/release_readiness_comparison_artifacts.py`, `src/minigpt/dataset_card_artifacts.py`, `src/minigpt/model_card_artifacts.py`, `src/minigpt/experiment_card.py`, `src/minigpt/experiment_card_artifacts.py`, `src/minigpt/project_audit.py`, `src/minigpt/project_audit_artifacts.py`, `src/minigpt/project_audit_contexts.py`, `src/minigpt/release_bundle.py`, `src/minigpt/release_bundle_artifacts.py`, `src/minigpt/release_readiness.py`, `src/minigpt/release_readiness_artifacts.py`, `src/minigpt/release_readiness_comparison.py`, `src/minigpt/maintenance_policy.py`, `src/minigpt/maintenance_pressure.py`, `src/minigpt/maintenance_policy_artifacts.py`, `src/minigpt/registry_assets.py`, `src/minigpt/registry_rankings.py`, `src/minigpt/registry_leaderboards.py`, `src/minigpt/pair_artifacts.py`, `src/minigpt/request_history.py`, `src/minigpt/eval_suite_artifacts.py`, `src/minigpt/benchmark_scorecard_scoring.py`, `src/minigpt/benchmark_scorecard_artifacts.py`, `src/minigpt/benchmark_scorecard_comparison_artifacts.py`, `src/minigpt/benchmark_scorecard_comparison_sections.py`, `src/minigpt/benchmark_scorecard_comparison_deltas.py`, `src/minigpt/benchmark_scorecard_decision_artifacts.py`, `src/minigpt/playground_assets.py`, `src/minigpt/playground_style.py`, `src/minigpt/playground_script.py`, `src/minigpt/playground_request_history_script.py`, `src/minigpt/registry_data.py`, `src/minigpt/registry_render.py`, `src/minigpt/registry_artifacts.py`, `src/minigpt/server_contracts.py`, `src/minigpt/server_checkpoints.py`, `src/minigpt/server_generator.py`, `src/minigpt/server_logging.py`, `src/minigpt/server_http.py`, `src/minigpt/server_request_history.py`, `src/minigpt/server_routes.py`, `src/minigpt/server_post_routes.py`, `src/minigpt/source_encoding_hygiene.py`, `src/minigpt/ci_workflow_hygiene.py`, `src/minigpt/ci_workflow_hygiene_artifacts.py`, related tests and v83-v183 explanations | Keep report builders, service handlers, UI asset modules, and training-scale handoff modules below pressure thresholds without hiding runtime behavior |
...
- Added `src/minigpt/maintenance_pressure.py` for module-pressure AST scanning, line-count classification, summary construction, and recommendations.
- Kept `maintenance_policy.py` as the legacy facade for `build_module_pressure_report()` and default module-pressure thresholds.
- Reduced `maintenance_policy.py` to batching/proposal policy responsibilities, with module pressure behavior and schema unchanged.
- Added facade identity tests so old maintenance-policy imports still resolve to the new pressure implementation.
- Confirmed focused maintenance tests, maintenance smoke, source encoding hygiene, and full unittest discovery pass.
