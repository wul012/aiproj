...
Version 291 lets the promoted seed handoff execution script run the assurance checker inline and embed the result back into the main JSON/CSV/Markdown/HTML report.
