...
Version 272 carries promotion clean batch-review evidence into the training-scale promotion index. The index now preserves handoff clean batch-review guard fields, excludes unclean clean-required promotions from compare inputs, renders the counts in artifacts, and prints them from the CLI.
