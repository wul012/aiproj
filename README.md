...
Version 280 adds a promoted seed handoff `automation_summary` that combines handoff execution status with the strict `automation_gate`, so CI and scripts can read one top-level decision, exit code, blocking source, and failed requirement list.
