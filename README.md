...
Version 320 lets the tiny scorecard comparison smoke run baseline and candidate with different tiny training budgets, then records the budget mode and max-iteration delta in the top-level comparison/decision summary.
