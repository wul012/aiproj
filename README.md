...
Version 273 carries clean batch-review enforcement into promoted training-scale comparison. The comparison layer now re-checks handoff clean batch-review guard fields, keeps dirty clean-required promoted rows visible, excludes them from compared runs, renders the counts in artifacts, and prints them from the CLI.
