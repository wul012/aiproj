...
- Use the v70 scale planner on a real larger Chinese corpus, then execute the generated v69-compatible batch and archive the resulting c/<version> evidence.
