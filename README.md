...
Version 309 carries handoff batch CI-regression context into promoted comparisons, so filtered clean-required inputs keep explicit exclusion reasons and stale compare-ready indexes are re-checked before comparison.
