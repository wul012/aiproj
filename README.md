...
Version 283 makes the promoted seed handoff receipt checker accept either a receipt JSON file or a handoff output directory and optionally write its own check JSON/text artifacts.
