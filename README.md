...
Version 301 carries CI workflow and CI order regressions from maturity narratives into training portfolio comparison, so best-score promotion is blocked when the leading portfolio is release-readiness CI-regressed.
