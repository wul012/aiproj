...
Version 317 adds a CPU-friendly tiny scorecard comparison smoke that runs two real tiny standard benchmark smokes, compares their benchmark scorecards, and records the comparison as plumbing evidence rather than a model-quality claim.
