...
Version 349 carries benchmark history readiness boundaries into release readiness comparison, so side-by-side release review now shows benchmark history deltas, regressions, quality-claim changes, and latest-boundary changes instead of hiding them behind generic panel changes.
...
- Evaluation path: fixed prompts -> generation quality -> benchmark scorecard -> rubric/drilldown -> cross-run comparison -> scorecard promotion decision -> benchmark history -> maturity narrative -> project audit -> release bundle -> release gate -> release readiness -> release readiness comparison.
...
The registry release readiness tracking layer reads per-run release readiness comparison outputs, adds improved/regressed/panel-changed/CI-regressed columns and counts, and surfaces Release Readiness Deltas beside loss, rubric, and pair evidence in registry HTML.
