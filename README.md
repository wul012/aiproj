...
Version 318 extends the CPU-friendly tiny scorecard comparison smoke with a benchmark scorecard decision step, so two real tiny runs now flow through scorecard comparison and decision evidence while still avoiding model-quality claims.
