...
Version 337 wraps the CI tiny scorecard inline smoke in a dedicated script, so GitHub Actions keeps a stable command while the fixed benchmark budget remains testable in code.
