...
Version 314 promotes the schema-v2 receipt CI-regression contract into the outer handoff assurance and CI smoke summaries, so the final gate can see the receipt schema, selected/aggregate CI counts, and comparison exclusion reasons directly.
