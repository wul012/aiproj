...
Version 256 carries handoff batch review context into training scale promotion evidence. Promotion JSON/CSV/Markdown/HTML now preserves selected batch review/blocker counts from the completed handoff before a run is treated as promotion-ready.
...
- Training scale promotion now preserves handoff selected batch review status, selected review/blocker counts, and handoff-level batch comparison totals.
- CSV/Markdown/HTML promotion artifacts expose those fields beside suite guard and variant readiness evidence.
- Promotion recommendations now surface handoff batch review/blocker actions before treating an otherwise complete handoff as promotion-ready evidence.
- Archived command-output evidence in `c/256`.
