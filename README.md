...
Version 338 makes the CI tiny scorecard wrapper write invocation plan artifacts, so the fixed benchmark budget, sidecar paths, final command, and return code are preserved with each run.
