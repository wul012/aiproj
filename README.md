...
Version 321 splits the promoted seed handoff artifact layer so receipt/check/assurance rendering lives in a dedicated receipt artifact module while the public handoff API stays stable.
