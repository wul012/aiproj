...
Version 249 adds an end-to-end coverage governance chain test. It protects the coverage regression signal from release readiness comparison through registry, maturity summary, and maturity narrative so future refactors cannot silently break the review path.
...
| Release and maturity governance | Registry, project audit, release bundle with request-history, CI-workflow hygiene, and coverage-gate evidence, split release bundle artifacts, release gate profiles using shared numeric helpers, release readiness dashboards with split artifact writers, release readiness comparisons with split artifact writers, registry tracking with CI workflow and coverage regression context, maturity summaries with CI workflow and coverage regression context, maturity narratives with coverage-regression and evaluation-review context, and an end-to-end coverage governance chain test | `maturity.py`, `maturity_artifacts.py`, `maturity_narrative_summary.py`, `maturity_narrative_sections.py`, `maturity_narrative_artifacts.py`, `registry_data.py`, `registry_rankings.py`, `registry_render.py`, `registry_leaderboards.py`, `release_gate.py`, `release_gate_artifacts.py`, `release_readiness.py`, `release_readiness_artifacts.py`, `release_readiness_comparison.py`, `release_readiness_comparison_artifacts.py`, `tests/test_coverage_governance_chain.py`, registry, release, readiness, maturity, audit tests plus versioned screenshots | Keep governance useful while avoiding more report-only fragmentation |
...
- Added `tests/test_coverage_governance_chain.py` as an end-to-end regression test.
- The test builds readiness comparison, registry, maturity summary, and maturity narrative in one fixture.
- Assertions protect coverage percent/gap deltas, registry `coverage-regressed`, maturity `warn`, and narrative `review`.
- No production behavior changed; this is a contract-preserving test hardening version.
- Archived command-output evidence in `c/249`.
