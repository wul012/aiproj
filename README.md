...
Version 315 adds a CPU-friendly tiny standard benchmark smoke that runs a real train -> eval suite -> generation quality -> benchmark scorecard chain and records the difference between evidence readiness and actual model quality.
