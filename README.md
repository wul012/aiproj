...
Version 284 lets the promoted seed handoff execution script optionally validate its freshly generated automation receipt and write receipt-check JSON/text artifacts before the final automation exit decision.
