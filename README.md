...
Version 288 lets the promoted seed handoff execution script run the embedded receipt-check verifier inline and archive its sidecar-integrity outputs.
