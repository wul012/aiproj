...
Version 230 carries scorecard-decision eval readiness into the maturity narrative. Non-comparison-ready scorecard decisions now surface as portfolio review evidence, while Markdown and HTML summaries show selected eval comparison status and non-ready candidate counts.
...
- Maturity narrative summary now consumes scorecard decision eval-suite comparison readiness.
- Non-comparison-ready scorecard decision candidates can mark the portfolio narrative as review-level evidence.
- Benchmark promotion section claim and boundary name selected eval comparison status and non-ready candidate count.
- Markdown and HTML maturity narrative outputs expose scorecard decision eval compare and non-ready candidate totals.
- Archived command-output evidence in `c/230`.
