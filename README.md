...
Version 348 carries benchmark history release-gate boundaries into the release readiness dashboard, so final readiness review shows benchmark history status, regressions, quality claims, and latest boundary beside the other panels.
...
- Evaluation path: fixed prompts -> generation quality -> benchmark scorecard -> rubric/drilldown -> cross-run comparison -> scorecard promotion decision -> benchmark history -> maturity narrative -> project audit -> release bundle -> release gate -> release readiness.
...
The release readiness comparison layer compares multiple readiness dashboards against a baseline and explains readiness status, panel, audit-score, missing-artifact, CI workflow, and action deltas across versions.
