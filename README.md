...
Version 334 adds a reusable tiny scorecard comparison smoke checker, so CI can validate an existing summary, artifacts, remediation gate, command status, and no-model-quality-claim boundary without rerunning training.
