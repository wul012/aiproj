...
Version 347 makes release gates and release gate profile comparisons inspect benchmark history release evidence, so repeated benchmark regressions and quality-claim boundaries cannot disappear after the bundle handoff.
...
- Evaluation path: fixed prompts -> generation quality -> benchmark scorecard -> rubric/drilldown -> cross-run comparison -> scorecard promotion decision -> benchmark history -> maturity narrative -> project audit -> release bundle -> release gate.
