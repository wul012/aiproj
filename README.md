...
Version 322 makes the tiny scorecard comparison smoke promotion threshold configurable, so real CPU benchmark smokes can record their decision rubric gate instead of hiding a fixed `80` in the script.
