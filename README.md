...
Version 312 carries promoted-seed CI-regression exclusion context into promoted seed handoffs, so the final next-cycle handoff keeps selected, aggregate, and comparison-ready CI regression evidence visible before the next plan command runs.
