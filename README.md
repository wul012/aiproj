...
Version 276 carries clean batch-review evidence into promoted seed handoff reports. The seed handoff layer now preserves selected clean batch-review status, clean/unclean handoff counts, and comparison-ready clean counts in JSON, CSV, Markdown, HTML, CLI output, and tests.
