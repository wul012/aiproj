...
Version 274 carries clean batch-review evidence into promoted baseline decisions. The decision layer now keeps selected clean batch-review status visible, rejects dirty clean-required promoted rows as baseline candidates, renders clean counts in artifacts, and prints them from the CLI.
