...
Version 323 adds top-level tiny scorecard decision threshold diagnostics, so blocked CPU benchmark smokes show the candidate, rubric score, configured threshold, and margin without opening the decision JSON.
