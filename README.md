...
Version 261 carries promoted-seed handoff batch review context into promoted training scale seed handoff reports. The handoff summary, CSV/Markdown/HTML outputs, CLI prints, and recommendations now keep selected batch review/blocker risk visible while preserving suite-alignment and clean-evidence semantics.
...
- Promoted training scale seed handoff now preserves promoted-seed handoff selected batch review status, selected review/blocker counts, and handoff-level batch comparison totals.
- CSV/Markdown/HTML handoff outputs and CLI prints expose selected and comparison-ready batch review/blocker context beside suite alignment, clean-evidence readiness, and plan artifact evidence.
- Handoff recommendations now warn when the validation/execution handoff comes from a seed that still carries selected handoff batch blocker or review actions, without changing suite-alignment or clean-evidence semantics.
- Archived command-output and Playwright/Chrome HTML evidence in `c/261`.
