...
Version 260 carries promoted-decision handoff batch review context into promoted training scale next-cycle seeds. The seed report, next-plan summary, CSV/Markdown/HTML outputs, CLI prints, and recommendations now keep selected batch review/blocker risk visible while preserving seed ready/review/blocked semantics.
...
- Promoted training scale next-cycle seed now preserves promoted-decision handoff selected batch review status, selected review/blocker counts, and handoff-level batch comparison totals.
- CSV/Markdown/HTML seed outputs and CLI prints expose selected and comparison-ready batch review/blocker context beside suite guard, next suite, and generated plan command evidence.
- Seed recommendations now warn when the next-cycle seed comes from a baseline that still carries selected handoff batch blocker or review actions, without changing seed readiness semantics.
- Archived command-output and Playwright/Chrome HTML evidence in `c/260`.
