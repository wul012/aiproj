...
Version 346 lets release bundles carry benchmark history context from project audit, so repeated benchmark evidence is preserved in release handoff artifacts.
...
- Evaluation path: fixed prompts -> generation quality -> benchmark scorecard -> rubric/drilldown -> cross-run comparison -> scorecard promotion decision -> benchmark history -> maturity narrative -> project audit -> release bundle.
