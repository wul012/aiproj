...
Version 279 makes the promoted seed handoff `automation_gate` easier for automation to consume by adding `decision`, `exit_code`, requirement counts, blocking counts, and a decision domain while keeping the existing status contract compatible.
