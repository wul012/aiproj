...
Version 285 persists inline receipt-check status back into the promoted seed handoff JSON, CSV, Markdown, and HTML artifacts while keeping the sidecar check JSON/text outputs optional.
