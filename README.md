...
Version 293 gives the promoted seed handoff assurance smoke a top-level JSON/text summary artifact, so CI and humans can inspect the smoke decision without scraping a long log.
