...
Version 343 adds a benchmark history ledger that connects scorecard comparison and decision artifacts across runs, so repeated real benchmark deltas can be reviewed as a history instead of isolated one-off reports.
