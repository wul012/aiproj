...
Version 350 carries benchmark history readiness comparison regressions into the run registry, so multi-run indexes can show benchmark-history regression counts, boundary changes, and leaderboard rows beside CI and coverage readiness evidence.
