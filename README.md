...
Version 306 carries batch CI-regression context from training-scale decisions into the consolidated workflow and execution handoff, so downstream automation can see and block CI-regressed batch evidence before execute handoff.
