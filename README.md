...
Version 275 carries clean batch-review evidence into promoted next-cycle seeds. The seed layer now preserves selected clean batch-review status, clean/unclean handoff counts, and comparison-ready clean counts in the seed artifact, rendered reports, CLI output, and tests.
