...
Version 290 adds a promoted seed handoff assurance checker that validates the main report, embedded receipt-check fields, and embedded-check JSON/text sidecars together.
