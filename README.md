...
Version 234 refines training portfolio comparison recommendations so best-scoring review portfolios and non-leading review portfolios get separate guidance. This keeps the maturity guard precise instead of over-warning clean best-score candidates.
...
- Training portfolio comparison recommendations now distinguish best-score review from non-leading review.
- Best-score review gets a direct clean-baseline warning.
- Non-leading review gets an archive/review reminder without implying the clean best-score candidate is unsafe.
- Focused tests cover both recommendation branches.
- Archived command-output evidence in `c/234`.
