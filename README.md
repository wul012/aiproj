...
Version 298 carries CI workflow order-violation deltas into release readiness comparison so cross-version reports can catch smoke-before-coverage drift even when CI pass/fail status stays unchanged.
