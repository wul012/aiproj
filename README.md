...
Version 325 moves scorecard decision threshold profiles into the decision artifact itself, so tiny smokes consume the same JSON/Markdown/HTML evidence instead of calculating profile fields only in the wrapper.
