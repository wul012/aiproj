...
Version 340 adds a reusable checker for CI tiny scorecard wrapper plans, so recorded summary/check artifact digests can be independently revalidated after the smoke run.
