...
- Add one consolidated release-readiness dashboard that shows registry, audit, release gate, request history, and maturity status in one browser report.
