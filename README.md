...
Version 341 promotes the CI tiny scorecard plan digest checker into GitHub Actions and CI workflow hygiene, so plan digest verification now runs before coverage instead of remaining a sidecar tool.
