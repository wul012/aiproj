...
Version 333 prints the first clean-remediation gate issue fields in the tiny scorecard comparison smoke text summary, so shell-only CI can classify strict stops without parsing JSON.
