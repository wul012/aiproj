...
Version 335 lets the tiny scorecard comparison smoke run the reusable summary checker inline, so one command can generate benchmark evidence and immediately write summary-check sidecars.
