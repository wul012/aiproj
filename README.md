...
Version 161 splits dataset card JSON/Markdown/HTML artifact writers into `dataset_card_artifacts.py`. The dataset card schema, CLI, and legacy `dataset_card.py` exports stay unchanged, while the main dataset card module drops from 567 lines to 247 lines.
...
- Added `src/minigpt/dataset_card_artifacts.py` for JSON, Markdown, and HTML dataset card writers/renderers.
- Kept `build_dataset_card()`, `scripts/build_dataset_card.py`, and legacy `dataset_card.py` exports compatible.
- Reduced `dataset_card.py` from 567 lines to 247 lines by moving artifact output code to a dedicated module.
