...
Version 344 lets the maturity narrative consume benchmark history ledgers, so repeated benchmark evidence can affect portfolio status, recommendations, summaries, CLI output, and rendered reports.
...
- Evaluation path: fixed prompts -> generation quality -> benchmark scorecard -> rubric/drilldown -> cross-run comparison -> scorecard promotion decision -> benchmark history -> maturity narrative.
