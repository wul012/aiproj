...
Version 310 carries promoted-comparison CI-regression exclusion context into promoted baseline decisions, so rejected baseline candidates explain why CI-regressed clean-required inputs stayed out of selection.
