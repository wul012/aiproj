...
Version 336 promotes the inline tiny scorecard summary-check smoke into GitHub Actions and CI workflow hygiene, so the evidence contract is enforced by CI instead of remaining a local option.
