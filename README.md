...
Version 236 adds structured review actions to training portfolio comparison reports. Comparison output now turns execution, artifact, quality, dataset, and maturity concerns into named actions with severity, reason, and evidence.
...
- Training portfolio comparison now emits structured `review_actions`.
- Actions classify execution, artifact, quality, dataset, and maturity review concerns.
- Best-score maturity review becomes a blocker action; non-leading maturity review remains a review action.
- Markdown and HTML render a dedicated Review Actions section.
- Archived command-output evidence in `c/236`.
