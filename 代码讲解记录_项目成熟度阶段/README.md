...
本目录保留 v48-v302 的项目成熟度、训练规模、自动化交接和 CI 回归治理讲解。后续训练治理与文档分流讲解从 v303 起写入同级目录 `代码讲解记录_训练治理阶段/`，本目录只做必要修正，不再继续堆新版本。
...
309-v295-promoted-seed-handoff-assurance-workflow-line-evidence.md
 -> v295 code explanation: expose line-number evidence for the promoted seed handoff assurance smoke order check.
...
305-v291-promoted-seed-handoff-inline-assurance.md
 -> v291 code explanation: wire promoted seed handoff assurance back into the execution script and main report artifacts.
...
302-v288-promoted-seed-handoff-inline-embedded-receipt-check.md
 -> v288 code explanation: let the promoted seed handoff execution script run embedded receipt-check sidecar integrity verification inline and archive outputs.
...
273-v259-promoted-decision-batch-review-propagation.md
 -> v259 code explanation: carry promoted-comparison handoff selected batch review/blocker context into promoted baseline decision rows, summaries, artifacts, CLI output, and recommendations.
272-v258-promoted-comparison-batch-review-propagation.md
 -> v258 code explanation: carry promotion-index handoff selected batch review/blocker context into promoted comparison rows, summaries, artifacts, CLI output, and recommendations.
...
262-v248-maturity-narrative-coverage-regression-context.md
 -> v248 code explanation: carry maturity coverage regression context into narrative summary, release-quality claims, Markdown/HTML stats, CLI output, and review recommendations.
...
248-v234-portfolio-maturity-recommendation-precision.md
 -> v234 code explanation: refine training portfolio comparison recommendations so best-score review and non-leading review portfolios produce distinct human guidance.
...
244-v230-maturity-narrative-eval-readiness.md
 -> v230 code explanation: carry scorecard decision eval-suite comparison readiness into maturity narrative summary, portfolio review status, sections, and rendered outputs.
...
241-v227-scorecard-eval-coverage-readiness.md
 -> v227 code explanation: carry eval-suite coverage/comparison readiness into benchmark scorecard scoring, summary, metrics, and recommendations while preserving legacy case-count behavior.
