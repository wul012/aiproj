...
from minigpt.packet_chain_index_v997 import (
    PACKET_INDEX_V997_JSON_FILENAME,
)
...
PACKET_REVIEW_V998_JSON_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_review_v998.json"
PACKET_REVIEW_V998_CSV_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_review_v998.csv"
PACKET_REVIEW_V998_TEXT_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_review_v998.txt"
PACKET_REVIEW_V998_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_review_v998.md"
PACKET_REVIEW_V998_HTML_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_review_v998.html"
...
def locate_receipt_index_v998(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_INDEX_V997_JSON_FILENAME
    return source
...
__all__ = [
    "PACKET_REVIEW_V998_CSV_FILENAME",
    "PACKET_REVIEW_V998_HTML_FILENAME",
    "PACKET_REVIEW_V998_JSON_FILENAME",
    "PACKET_REVIEW_V998_MARKDOWN_FILENAME",
    "PACKET_REVIEW_V998_TEXT_FILENAME",
