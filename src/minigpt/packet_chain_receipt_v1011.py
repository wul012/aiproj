...
PACKET_RECEIPT_V1011_JSON_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1011.json"
PACKET_RECEIPT_V1011_CSV_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1011.csv"
PACKET_RECEIPT_V1011_TEXT_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1011.txt"
PACKET_RECEIPT_V1011_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1011.md"
PACKET_RECEIPT_V1011_HTML_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1011.html"
...
def locate_receipt_index_review_v1011(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_REVIEW_V1010_JSON_FILENAME
    return source
...
def build_packet_receipt_v1011(
...
__all__ = [
    "PACKET_RECEIPT_V1011_CSV_FILENAME",
    "PACKET_RECEIPT_V1011_HTML_FILENAME",
    "PACKET_RECEIPT_V1011_JSON_FILENAME",
    "PACKET_RECEIPT_V1011_MARKDOWN_FILENAME",
    "PACKET_RECEIPT_V1011_TEXT_FILENAME",
