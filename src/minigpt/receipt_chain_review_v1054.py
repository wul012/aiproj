...
RECEIPT_REVIEW_V1054_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1054.json"
RECEIPT_REVIEW_V1054_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1054.csv"
RECEIPT_REVIEW_V1054_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1054.txt"
RECEIPT_REVIEW_V1054_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1054.md"
RECEIPT_REVIEW_V1054_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1054.html"
...
def locate_receipt_index_v1054(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1053_JSON_FILENAME
    return source
...
def build_receipt_review_v1054(
...
__all__ = [
    "RECEIPT_REVIEW_V1054_CSV_FILENAME",
    "RECEIPT_REVIEW_V1054_HTML_FILENAME",
    "RECEIPT_REVIEW_V1054_JSON_FILENAME",
    "RECEIPT_REVIEW_V1054_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1054_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1054",
