...
RECEIPT_REVIEW_V1058_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1058.json"
RECEIPT_REVIEW_V1058_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1058.csv"
RECEIPT_REVIEW_V1058_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1058.txt"
RECEIPT_REVIEW_V1058_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1058.md"
RECEIPT_REVIEW_V1058_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1058.html"
...
def locate_receipt_index_v1058(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1057_JSON_FILENAME
    return source
...
def build_receipt_review_v1058(
...
__all__ = [
    "RECEIPT_REVIEW_V1058_CSV_FILENAME",
    "RECEIPT_REVIEW_V1058_HTML_FILENAME",
    "RECEIPT_REVIEW_V1058_JSON_FILENAME",
    "RECEIPT_REVIEW_V1058_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1058_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1058",
