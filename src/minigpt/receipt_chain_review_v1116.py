...
RECEIPT_REVIEW_V1116_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1116.json"
RECEIPT_REVIEW_V1116_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1116.csv"
RECEIPT_REVIEW_V1116_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1116.txt"
RECEIPT_REVIEW_V1116_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1116.md"
RECEIPT_REVIEW_V1116_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1116.html"
...
def locate_receipt_index_v1116(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1115_JSON_FILENAME
    return source
...
def build_receipt_review_v1116(
...
__all__ = [
    "RECEIPT_REVIEW_V1116_CSV_FILENAME",
    "RECEIPT_REVIEW_V1116_HTML_FILENAME",
    "RECEIPT_REVIEW_V1116_JSON_FILENAME",
    "RECEIPT_REVIEW_V1116_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1116_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1116",
