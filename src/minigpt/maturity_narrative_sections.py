...
def _release_claim(summary: dict[str, Any]) -> str:
    return (
        ...
        f"CI archived path regressions={summary.get('release_readiness_ci_archived_path_portability_check_ready_regression_count') or 0}, "
        ...
        f"benchmark suite-design deltas={summary.get('release_readiness_benchmark_suite_design_delta_count') or 0}, "
        f"suite-design regressions={summary.get('release_readiness_benchmark_suite_design_regression_count') or 0}, "
        f"design changes={summary.get('release_readiness_benchmark_design_change_delta_count') or 0}, "
        f"max suite-design delta="
        f"{summary.get('release_readiness_max_benchmark_suite_design_delta') if summary.get('release_readiness_max_benchmark_suite_design_delta') is not None else 'missing'}, "
        f"max design-change delta="
        f"{summary.get('release_readiness_max_benchmark_design_change_delta') if summary.get('release_readiness_max_benchmark_design_change_delta') is not None else 'missing'}, "
