    ...
    lines = [
        ...
        *_markdown_table(
            [
                ...
                ("Eval coverage", summary.get("eval_suite_coverage_status")),
                ("Eval comparison", summary.get("eval_suite_comparison_status")),
                ("Suite design coverage", summary.get("eval_suite_design_coverage_status")),
                ("Suite design comparison", summary.get("eval_suite_design_comparison_status")),
                ("Suite design duplicate seeds", summary.get("eval_suite_design_duplicate_seed_count")),
...
def render_benchmark_scorecard_html(scorecard: dict[str, Any]) -> str:
    ...
    stats = [
        ...
        ("Eval coverage", summary.get("eval_suite_coverage_status")),
        ("Eval comparison", summary.get("eval_suite_comparison_status")),
        ("Design coverage", summary.get("eval_suite_design_coverage_status")),
        ("Design comparison", summary.get("eval_suite_design_comparison_status")),
