    ...
    write_csv_row(
        {
            ...
            "require_clean_batch_review": summary.get("require_clean_batch_review"),
...
def render_training_scale_run_decision_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Require clean batch review: `{summary.get('require_clean_batch_review')}`",
...
def render_training_scale_run_decision_html(report: dict[str, Any]) -> str:
    ...
    stats = [
        ...
        ("Require clean batch review", summary.get("require_clean_batch_review")),
