...
RECEIPT_REVIEW_V1108_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1108.json"
RECEIPT_REVIEW_V1108_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1108.csv"
RECEIPT_REVIEW_V1108_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1108.txt"
RECEIPT_REVIEW_V1108_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1108.md"
RECEIPT_REVIEW_V1108_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1108.html"
...
def locate_receipt_index_v1108(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1107_JSON_FILENAME
    return source
...
def build_receipt_review_v1108(
...
__all__ = [
    "RECEIPT_REVIEW_V1108_CSV_FILENAME",
    "RECEIPT_REVIEW_V1108_HTML_FILENAME",
    "RECEIPT_REVIEW_V1108_JSON_FILENAME",
    "RECEIPT_REVIEW_V1108_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1108_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1108",
