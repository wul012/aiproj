...
from minigpt.receipt_chain_check_v1080 import (
    RECEIPT_CHECK_V1080_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1081_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1081.json"
RECEIPT_CHAIN_V1081_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1081.csv"
RECEIPT_CHAIN_V1081_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1081.txt"
RECEIPT_CHAIN_V1081_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1081.md"
RECEIPT_CHAIN_V1081_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1081.html"
...
def locate_receipt_check_v1081(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1080_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1081_CSV_FILENAME",
    "RECEIPT_CHAIN_V1081_HTML_FILENAME",
    "RECEIPT_CHAIN_V1081_JSON_FILENAME",
    "RECEIPT_CHAIN_V1081_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1081_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1081",
