...
from minigpt.packet_chain_index_v1001 import (
    PACKET_INDEX_V1001_JSON_FILENAME,
)
...
PACKET_REVIEW_V1002_JSON_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_review_v1002.json"
PACKET_REVIEW_V1002_CSV_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_review_v1002.csv"
PACKET_REVIEW_V1002_TEXT_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_review_v1002.txt"
PACKET_REVIEW_V1002_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_review_v1002.md"
PACKET_REVIEW_V1002_HTML_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_review_v1002.html"
...
def locate_receipt_index_v1002(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_INDEX_V1001_JSON_FILENAME
    return source
...
__all__ = [
    "PACKET_REVIEW_V1002_CSV_FILENAME",
    "PACKET_REVIEW_V1002_HTML_FILENAME",
    "PACKET_REVIEW_V1002_JSON_FILENAME",
    "PACKET_REVIEW_V1002_MARKDOWN_FILENAME",
    "PACKET_REVIEW_V1002_TEXT_FILENAME",
