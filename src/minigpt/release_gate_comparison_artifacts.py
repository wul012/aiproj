...
def write_release_gate_profile_comparison_csv(report: dict[str, Any], path: str | Path) -> None:
    ...
    fieldnames = [
        ...
        "require_benchmark_history_gate_check",
...
def write_release_gate_profile_delta_csv(report: dict[str, Any], path: str | Path) -> None:
    ...
    fieldnames = [
        ...
        "baseline_require_benchmark_history",
        "compared_require_benchmark_history",
...
def render_release_gate_profile_comparison_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        "## Profile Matrix",
        "",
        "| Bundle | Profile | Decision | Gate | Audit score | Min score | Generation quality required | Request history required | Benchmark history required | Test coverage required | Failed checks | Warned checks |",
        "| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |",
    ]
        ...
        lines.append(
            ...
            + " | ".join(
                [
                    ...
                    _md(row.get("require_benchmark_history_gate_check")),
...
def render_release_gate_profile_comparison_html(report: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "<th>Bundle</th><th>Profile</th><th>Decision</th><th>Gate</th><th>Audit</th><th>Min</th><th>Generation</th><th>Request history</th><th>Benchmark history</th><th>Coverage</th><th>Failed</th><th>Warned</th>"
            "</tr></thead><tbody>"
            + rows
            + "</tbody></table></section>",
...
def _html_row(row: dict[str, Any]) -> str:
    ...
    return (
        ...
        f"<td>{_e(row.get('require_benchmark_history_gate_check'))}</td>"
