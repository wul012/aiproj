...
RECEIPT_REVIEW_V1104_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1104.json"
RECEIPT_REVIEW_V1104_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1104.csv"
RECEIPT_REVIEW_V1104_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1104.txt"
RECEIPT_REVIEW_V1104_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1104.md"
RECEIPT_REVIEW_V1104_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1104.html"
...
def locate_receipt_index_v1104(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1103_JSON_FILENAME
    return source
...
def build_receipt_review_v1104(
...
__all__ = [
    "RECEIPT_REVIEW_V1104_CSV_FILENAME",
    "RECEIPT_REVIEW_V1104_HTML_FILENAME",
    "RECEIPT_REVIEW_V1104_JSON_FILENAME",
    "RECEIPT_REVIEW_V1104_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1104_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1104",
