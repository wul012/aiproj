...
RECEIPT_CHAIN_V1097_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1097.json"
RECEIPT_CHAIN_V1097_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1097.csv"
RECEIPT_CHAIN_V1097_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1097.txt"
RECEIPT_CHAIN_V1097_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1097.md"
RECEIPT_CHAIN_V1097_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1097.html"
...
def locate_receipt_check_v1097(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1096_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1097_CSV_FILENAME",
    "RECEIPT_CHAIN_V1097_HTML_FILENAME",
    "RECEIPT_CHAIN_V1097_JSON_FILENAME",
    "RECEIPT_CHAIN_V1097_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1097_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1097",
