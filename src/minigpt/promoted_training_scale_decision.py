...
def _summary(
    ...
    *,
    ...
    return {
        ...
        "selected_handoff_require_suite_consistency": None if selected is None else selected.get("handoff_require_suite_consistency"),
        "selected_handoff_suite_consistency": None if selected is None else selected.get("handoff_suite_consistency"),
        "selected_handoff_suite_mismatch_count": None if selected is None else selected.get("handoff_suite_mismatch_count"),
        "selected_handoff_selected_suite_path": None if selected is None else selected.get("handoff_selected_suite_path"),
        ...
        "comparison_ready_handoff_suite_mismatch_total": comparison_summary.get("comparison_ready_handoff_suite_mismatch_total"),
...
def _recommendations(
    ...
    *,
    ...
    if decision_status == "accepted":
        ...
        _append_handoff_batch_recommendations(recommendations, selected, comparison_summary)
...
def _append_handoff_batch_recommendations(
