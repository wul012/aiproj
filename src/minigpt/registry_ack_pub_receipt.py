...
ACK_PUB_RECEIPT_JSON_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt.json"
ACK_PUB_RECEIPT_CSV_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt.csv"
ACK_PUB_RECEIPT_TEXT_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt.txt"
ACK_PUB_RECEIPT_MARKDOWN_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt.md"
ACK_PUB_RECEIPT_HTML_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt.html"
...
def locate_ack_pub_receipt(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / ACK_PUB_REVIEW_JSON_FILENAME
    return source
...
__all__ = [
    "ACK_PUB_RECEIPT_CSV_FILENAME",
    "ACK_PUB_RECEIPT_HTML_FILENAME",
    "ACK_PUB_RECEIPT_JSON_FILENAME",
    "ACK_PUB_RECEIPT_MARKDOWN_FILENAME",
    "ACK_PUB_RECEIPT_TEXT_FILENAME",
    "build_ack_pub_receipt",
    "locate_ack_pub_receipt",
    "read_json_report",
    "resolve_exit_code",
]
