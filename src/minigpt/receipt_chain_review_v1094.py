...
RECEIPT_REVIEW_V1094_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1094.json"
RECEIPT_REVIEW_V1094_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1094.csv"
RECEIPT_REVIEW_V1094_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1094.txt"
RECEIPT_REVIEW_V1094_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1094.md"
RECEIPT_REVIEW_V1094_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1094.html"
...
def locate_receipt_index_v1094(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1093_JSON_FILENAME
    return source
...
def build_receipt_review_v1094(
...
__all__ = [
    "RECEIPT_REVIEW_V1094_CSV_FILENAME",
    "RECEIPT_REVIEW_V1094_HTML_FILENAME",
    "RECEIPT_REVIEW_V1094_JSON_FILENAME",
    "RECEIPT_REVIEW_V1094_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1094_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
