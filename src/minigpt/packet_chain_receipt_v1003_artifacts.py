...
def write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_v1003_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / PACKET_RECEIPT_V1003_JSON_FILENAME,
        "csv": root / PACKET_RECEIPT_V1003_CSV_FILENAME,
        "text": root / PACKET_RECEIPT_V1003_TEXT_FILENAME,
        "markdown": root / PACKET_RECEIPT_V1003_MARKDOWN_FILENAME,
        "html": root / PACKET_RECEIPT_V1003_HTML_FILENAME,
    }
