"""Model capability route-promotion lazy exports for the root facade."""
...
ROOT_FACADE_ROUTE_PROMOTION_LAZY_EXPORTS = {
    ...
    'build_model_capability_route_promotion_release_readiness_summary': (
        'model_capability_route_promotion_release_readiness_summary',
        'build_model_capability_route_promotion_release_readiness_summary',
    ),
    'write_model_capability_route_promotion_release_readiness_summary_outputs': (
        'model_capability_route_promotion_release_readiness_summary_artifacts',
        'write_model_capability_route_promotion_release_readiness_summary_outputs',
    ),
    'build_model_capability_route_promotion_release_readiness_summary_check': (
        'model_capability_route_promotion_release_readiness_summary_check',
        'build_model_capability_route_promotion_release_readiness_summary_check',
    ),
    ...
    'build_model_capability_route_promotion_release_readiness_receipt_index': (
        'model_capability_route_promotion_release_readiness_receipt_index',
        'build_model_capability_route_promotion_release_readiness_receipt_index',
    ),
    'write_model_capability_route_promotion_release_readiness_receipt_index_outputs': (
        'model_capability_route_promotion_release_readiness_receipt_index_artifacts',
        'write_model_capability_route_promotion_release_readiness_receipt_index_outputs',
    ),
    'build_model_capability_route_promotion_release_readiness_receipt_index_review': (
        'model_capability_route_promotion_release_readiness_receipt_index_review',
        'build_model_capability_route_promotion_release_readiness_receipt_index_review',
    ),
    'write_model_capability_route_promotion_release_readiness_receipt_index_review_outputs': (
        'model_capability_route_promotion_release_readiness_receipt_index_review_artifacts',
        'write_model_capability_route_promotion_release_readiness_receipt_index_review_outputs',
    ),
...
__all__ = ["ROOT_FACADE_ROUTE_PROMOTION_LAZY_EXPORTS"]
