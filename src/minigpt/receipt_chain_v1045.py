...
from minigpt.receipt_chain_check_v1044 import (
    RECEIPT_CHECK_V1044_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1045_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1045.json"
RECEIPT_CHAIN_V1045_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1045.csv"
RECEIPT_CHAIN_V1045_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1045.txt"
RECEIPT_CHAIN_V1045_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1045.md"
RECEIPT_CHAIN_V1045_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1045.html"
...
def locate_receipt_v1045(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1043_JSON_FILENAME
    return source
...
def locate_receipt_check_v1045(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1044_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1045_CSV_FILENAME",
    "RECEIPT_CHAIN_V1045_HTML_FILENAME",
    "RECEIPT_CHAIN_V1045_JSON_FILENAME",
    "RECEIPT_CHAIN_V1045_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1045_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1045",
