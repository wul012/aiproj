...
from minigpt.receipt_chain_check_v1060 import (
    RECEIPT_CHECK_V1060_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1061_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1061.json"
RECEIPT_CHAIN_V1061_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1061.csv"
RECEIPT_CHAIN_V1061_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1061.txt"
RECEIPT_CHAIN_V1061_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1061.md"
RECEIPT_CHAIN_V1061_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1061.html"
...
def locate_receipt_v1061(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1059_JSON_FILENAME
    return source
...
def locate_receipt_check_v1061(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1060_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1061_CSV_FILENAME",
    "RECEIPT_CHAIN_V1061_HTML_FILENAME",
    "RECEIPT_CHAIN_V1061_JSON_FILENAME",
    "RECEIPT_CHAIN_V1061_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1061_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1061",
