...
from minigpt.packet_chain_index_v1009 import (
    PACKET_INDEX_V1009_JSON_FILENAME,
)
...
PACKET_REVIEW_V1010_JSON_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1010.json"
PACKET_REVIEW_V1010_CSV_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1010.csv"
PACKET_REVIEW_V1010_TEXT_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1010.txt"
PACKET_REVIEW_V1010_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1010.md"
PACKET_REVIEW_V1010_HTML_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1010.html"
...
def locate_receipt_index_v1010(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_INDEX_V1009_JSON_FILENAME
    return source
...
__all__ = [
    "PACKET_REVIEW_V1010_CSV_FILENAME",
    "PACKET_REVIEW_V1010_HTML_FILENAME",
    "PACKET_REVIEW_V1010_JSON_FILENAME",
    "PACKET_REVIEW_V1010_MARKDOWN_FILENAME",
    "PACKET_REVIEW_V1010_TEXT_FILENAME",
    "build_packet_review_v1010",
