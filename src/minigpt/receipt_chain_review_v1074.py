...
RECEIPT_REVIEW_V1074_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1074.json"
RECEIPT_REVIEW_V1074_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1074.csv"
RECEIPT_REVIEW_V1074_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1074.txt"
RECEIPT_REVIEW_V1074_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1074.md"
RECEIPT_REVIEW_V1074_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1074.html"
...
def locate_receipt_index_v1074(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1073_JSON_FILENAME
    return source
...
def build_receipt_review_v1074(
...
__all__ = [
    "RECEIPT_REVIEW_V1074_CSV_FILENAME",
    "RECEIPT_REVIEW_V1074_HTML_FILENAME",
    "RECEIPT_REVIEW_V1074_JSON_FILENAME",
    "RECEIPT_REVIEW_V1074_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1074_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1074",
