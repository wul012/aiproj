...
from minigpt.receipt_chain_check_v1114 import (
    RECEIPT_CHECK_V1114_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1115_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1115.json"
RECEIPT_CHAIN_V1115_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1115.csv"
RECEIPT_CHAIN_V1115_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1115.txt"
RECEIPT_CHAIN_V1115_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1115.md"
RECEIPT_CHAIN_V1115_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1115.html"
...
def locate_receipt_check_v1115(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1114_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1115_CSV_FILENAME",
    "RECEIPT_CHAIN_V1115_HTML_FILENAME",
    "RECEIPT_CHAIN_V1115_JSON_FILENAME",
    "RECEIPT_CHAIN_V1115_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1115_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1115",
