...
RECEIPT_REVIEW_V1112_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1112.json"
RECEIPT_REVIEW_V1112_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1112.csv"
RECEIPT_REVIEW_V1112_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1112.txt"
RECEIPT_REVIEW_V1112_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1112.md"
RECEIPT_REVIEW_V1112_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1112.html"
...
def locate_receipt_index_v1112(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1111_JSON_FILENAME
    return source
...
def build_receipt_review_v1112(
...
__all__ = [
    "RECEIPT_REVIEW_V1112_CSV_FILENAME",
    "RECEIPT_REVIEW_V1112_HTML_FILENAME",
    "RECEIPT_REVIEW_V1112_JSON_FILENAME",
    "RECEIPT_REVIEW_V1112_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1112_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1112",
