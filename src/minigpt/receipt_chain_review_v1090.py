...
RECEIPT_REVIEW_V1090_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1090.json"
RECEIPT_REVIEW_V1090_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1090.csv"
RECEIPT_REVIEW_V1090_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1090.txt"
RECEIPT_REVIEW_V1090_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1090.md"
RECEIPT_REVIEW_V1090_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1090.html"
...
def locate_receipt_index_v1090(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1089_JSON_FILENAME
    return source
...
def build_receipt_review_v1090(
...
__all__ = [
    "RECEIPT_REVIEW_V1090_CSV_FILENAME",
    "RECEIPT_REVIEW_V1090_HTML_FILENAME",
    "RECEIPT_REVIEW_V1090_JSON_FILENAME",
    "RECEIPT_REVIEW_V1090_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1090_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1090",
