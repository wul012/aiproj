...
from minigpt.packet_chain_review_v994 import (
    PACKET_REVIEW_V994_CSV_FILENAME,
    PACKET_REVIEW_V994_HTML_FILENAME,
    PACKET_REVIEW_V994_JSON_FILENAME,
    PACKET_REVIEW_V994_MARKDOWN_FILENAME,
    PACKET_REVIEW_V994_TEXT_FILENAME,
)
...
def write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_review_v994_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / PACKET_REVIEW_V994_JSON_FILENAME,
        "csv": root / PACKET_REVIEW_V994_CSV_FILENAME,
        "text": root / PACKET_REVIEW_V994_TEXT_FILENAME,
        "markdown": root / PACKET_REVIEW_V994_MARKDOWN_FILENAME,
        "html": root / PACKET_REVIEW_V994_HTML_FILENAME,
    }
