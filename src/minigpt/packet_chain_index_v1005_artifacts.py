...
def write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_v1005_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / PACKET_INDEX_V1005_JSON_FILENAME,
        "csv": root / PACKET_INDEX_V1005_CSV_FILENAME,
        "text": root / PACKET_INDEX_V1005_TEXT_FILENAME,
        "markdown": root / PACKET_INDEX_V1005_MARKDOWN_FILENAME,
        "html": root / PACKET_INDEX_V1005_HTML_FILENAME,
    }
