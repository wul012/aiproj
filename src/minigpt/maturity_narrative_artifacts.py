    ...
    lines = [
        ...
        *_markdown_table(
            [
                ...
                ("Release CI regression reasons", _fmt_mapping(summary.get("release_readiness_ci_workflow_regression_reason_counts"))),
                ("Release CI tiny plan regressions", summary.get("release_readiness_ci_tiny_plan_digest_gate_ready_regression_count")),
                ("Release CI boundary gate regressions", summary.get("release_readiness_ci_boundary_gate_check_ready_regression_count")),
                ("Release CI boundary plan regressions", summary.get("release_readiness_ci_boundary_plan_check_ready_regression_count")),
                ("Release CI archived path regressions", summary.get("release_readiness_ci_archived_path_portability_check_ready_regression_count")),
                ("Release CI drift smoke regressions", summary.get("release_readiness_ci_drift_smoke_ready_regression_count")),
                ...
                ("Release benchmark suite-design deltas", summary.get("release_readiness_benchmark_suite_design_delta_count")),
                ("Release benchmark suite-design regressions", summary.get("release_readiness_benchmark_suite_design_regression_count")),
                ("Release benchmark design changes", summary.get("release_readiness_benchmark_design_change_delta_count")),
                ("Release benchmark suite-design max", summary.get("release_readiness_max_benchmark_suite_design_delta")),
                ("Release benchmark design-change max", summary.get("release_readiness_max_benchmark_design_change_delta")),
                (
                ...
                ("Benchmark histories", summary.get("benchmark_history_count")),
                ("Benchmark history entries", summary.get("benchmark_history_entry_count")),
...
def render_maturity_narrative_html(narrative: dict[str, Any]) -> str:
    ...
    stats = [
        ...
        ("CI reasons", _fmt_mapping(summary.get("release_readiness_ci_workflow_regression_reason_counts"))),
        ("CI boundary plan", summary.get("release_readiness_ci_boundary_plan_check_ready_regression_count")),
        ("CI archived paths", summary.get("release_readiness_ci_archived_path_portability_check_ready_regression_count")),
        ...
        ("Benchmark suite deltas", summary.get("release_readiness_benchmark_suite_design_delta_count")),
        ("Benchmark suite regressions", summary.get("release_readiness_benchmark_suite_design_regression_count")),
        ("Benchmark design changes", summary.get("release_readiness_benchmark_design_change_delta_count")),
        ("Benchmark suite max", summary.get("release_readiness_max_benchmark_suite_design_delta")),
        ("Benchmark design max", summary.get("release_readiness_max_benchmark_design_change_delta")),
        ...
        ("Histories", summary.get("benchmark_history_count")),
