...
RECEIPT_REVIEW_V1124_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1124.json"
RECEIPT_REVIEW_V1124_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1124.csv"
RECEIPT_REVIEW_V1124_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1124.txt"
RECEIPT_REVIEW_V1124_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1124.md"
RECEIPT_REVIEW_V1124_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1124.html"
...
def locate_receipt_index_v1124(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1123_JSON_FILENAME
    return source
...
def build_receipt_review_v1124(
...
__all__ = [
    "RECEIPT_REVIEW_V1124_CSV_FILENAME",
    "RECEIPT_REVIEW_V1124_HTML_FILENAME",
    "RECEIPT_REVIEW_V1124_JSON_FILENAME",
    "RECEIPT_REVIEW_V1124_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1124_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1124",
