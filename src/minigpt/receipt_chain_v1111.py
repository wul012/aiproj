...
from minigpt.receipt_chain_check_v1110 import (
    RECEIPT_CHECK_V1110_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1111_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1111.json"
RECEIPT_CHAIN_V1111_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1111.csv"
RECEIPT_CHAIN_V1111_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1111.txt"
RECEIPT_CHAIN_V1111_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1111.md"
RECEIPT_CHAIN_V1111_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1111.html"
...
def locate_receipt_check_v1111(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1110_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1111_CSV_FILENAME",
    "RECEIPT_CHAIN_V1111_HTML_FILENAME",
    "RECEIPT_CHAIN_V1111_JSON_FILENAME",
    "RECEIPT_CHAIN_V1111_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1111_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1111",
