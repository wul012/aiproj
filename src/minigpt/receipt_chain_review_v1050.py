...
RECEIPT_REVIEW_V1050_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1050.json"
RECEIPT_REVIEW_V1050_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1050.csv"
RECEIPT_REVIEW_V1050_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1050.txt"
RECEIPT_REVIEW_V1050_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1050.md"
RECEIPT_REVIEW_V1050_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1050.html"
...
def locate_receipt_index_v1050(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1049_JSON_FILENAME
    return source
...
def build_receipt_review_v1050(
...
__all__ = [
    "RECEIPT_REVIEW_V1050_CSV_FILENAME",
    "RECEIPT_REVIEW_V1050_HTML_FILENAME",
    "RECEIPT_REVIEW_V1050_JSON_FILENAME",
    "RECEIPT_REVIEW_V1050_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1050_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1050",
