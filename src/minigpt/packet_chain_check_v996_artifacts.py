...
def write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_check_v996_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / PACKET_CHECK_V996_JSON_FILENAME,
        "csv": root / PACKET_CHECK_V996_CSV_FILENAME,
        "text": root / PACKET_CHECK_V996_TEXT_FILENAME,
        "markdown": root / PACKET_CHECK_V996_MARKDOWN_FILENAME,
        "html": root / PACKET_CHECK_V996_HTML_FILENAME,
    }
