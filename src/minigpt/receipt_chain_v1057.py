...
from minigpt.receipt_chain_check_v1056 import (
    RECEIPT_CHECK_V1056_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1057_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1057.json"
RECEIPT_CHAIN_V1057_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1057.csv"
RECEIPT_CHAIN_V1057_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1057.txt"
RECEIPT_CHAIN_V1057_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1057.md"
RECEIPT_CHAIN_V1057_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1057.html"
...
def locate_receipt_v1057(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1055_JSON_FILENAME
    return source
...
def locate_receipt_check_v1057(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1056_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1057_CSV_FILENAME",
    "RECEIPT_CHAIN_V1057_HTML_FILENAME",
    "RECEIPT_CHAIN_V1057_JSON_FILENAME",
    "RECEIPT_CHAIN_V1057_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1057_TEXT_FILENAME",
    "READY_KEY",
