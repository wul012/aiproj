...
ACK_PUB_REVIEW_JSON_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_index_review.json"
ACK_PUB_REVIEW_CSV_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_index_review.csv"
ACK_PUB_REVIEW_TEXT_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_index_review.txt"
ACK_PUB_REVIEW_MARKDOWN_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_index_review.md"
ACK_PUB_REVIEW_HTML_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_index_review.html"
...
def locate_ack_pub_review(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / REGISTRY_ACK_PUB_INDEX_JSON_FILENAME
    return source
...
__all__ = [
    "ACK_PUB_REVIEW_CSV_FILENAME",
    "ACK_PUB_REVIEW_HTML_FILENAME",
    "ACK_PUB_REVIEW_JSON_FILENAME",
    "ACK_PUB_REVIEW_MARKDOWN_FILENAME",
    "ACK_PUB_REVIEW_TEXT_FILENAME",
    "build_ack_pub_review",
    "locate_ack_pub_review",
    "read_json_report",
    "resolve_exit_code",
]
