...
ACK_BUNDLE_RECEIPT_JSON_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt.json"
ACK_BUNDLE_RECEIPT_CSV_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt.csv"
ACK_BUNDLE_RECEIPT_TEXT_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt.txt"
ACK_BUNDLE_RECEIPT_MARKDOWN_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt.md"
ACK_BUNDLE_RECEIPT_HTML_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt.html"
...
def locate_ack_bundle_receipt(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / ACK_BUNDLE_REVIEW_JSON_FILENAME
    return source
