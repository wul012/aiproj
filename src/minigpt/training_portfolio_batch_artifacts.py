...
def render_training_portfolio_batch_markdown(report: dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"- Suite-design regressed portfolios: `{', '.join(_string_list(review.get('maturity_suite_design_regression_names'))) or 'none'}`",
...
def render_training_portfolio_batch_html(report: dict[str, Any]) -> str:
    ...
    stats = [
        ...
        ("Review actions", review.get("review_action_count", 0)),
        ("Blocker actions", review.get("blocker_action_count", 0)),
        ("Suite-design regressions", review.get("maturity_suite_design_regression_count", 0)),
