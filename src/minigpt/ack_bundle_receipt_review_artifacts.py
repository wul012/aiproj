...
def write_randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_review_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / RECEIPT_REVIEW_JSON_FILENAME,
        "csv": root / RECEIPT_REVIEW_CSV_FILENAME,
        "text": root / RECEIPT_REVIEW_TEXT_FILENAME,
        "markdown": root / RECEIPT_REVIEW_MARKDOWN_FILENAME,
        "html": root / RECEIPT_REVIEW_HTML_FILENAME,
    }
