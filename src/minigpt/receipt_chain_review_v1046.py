...
RECEIPT_REVIEW_V1046_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1046.json"
RECEIPT_REVIEW_V1046_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1046.csv"
RECEIPT_REVIEW_V1046_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1046.txt"
RECEIPT_REVIEW_V1046_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1046.md"
RECEIPT_REVIEW_V1046_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1046.html"
...
def locate_receipt_index_v1046(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1045_JSON_FILENAME
    return source
...
def build_receipt_review_v1046(
...
__all__ = [
    "RECEIPT_REVIEW_V1046_CSV_FILENAME",
    "RECEIPT_REVIEW_V1046_HTML_FILENAME",
    "RECEIPT_REVIEW_V1046_JSON_FILENAME",
    "RECEIPT_REVIEW_V1046_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1046_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1046",
