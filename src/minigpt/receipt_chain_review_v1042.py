...
from minigpt.receipt_chain_v1041 import (
    LOOKUP_KEY_PREFIX,
    RECEIPT_CHAIN_V1041_JSON_FILENAME,
...
RECEIPT_REVIEW_V1042_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1042.json"
RECEIPT_REVIEW_V1042_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1042.csv"
RECEIPT_REVIEW_V1042_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1042.txt"
RECEIPT_REVIEW_V1042_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1042.md"
RECEIPT_REVIEW_V1042_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1042.html"
...
def locate_receipt_index_v1042(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1041_JSON_FILENAME
    return source
...
def build_receipt_review_v1042(
...
__all__ = [
    "RECEIPT_REVIEW_V1042_CSV_FILENAME",
    "RECEIPT_REVIEW_V1042_HTML_FILENAME",
    "RECEIPT_REVIEW_V1042_JSON_FILENAME",
    "RECEIPT_REVIEW_V1042_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1042_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1042",
