...
from minigpt.receipt_chain_check_v1068 import (
    RECEIPT_CHECK_V1068_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1069_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1069.json"
RECEIPT_CHAIN_V1069_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1069.csv"
RECEIPT_CHAIN_V1069_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1069.txt"
RECEIPT_CHAIN_V1069_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1069.md"
RECEIPT_CHAIN_V1069_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1069.html"
...
def locate_receipt_v1069(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1067_JSON_FILENAME
    return source
...
def locate_receipt_check_v1069(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1068_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1069_CSV_FILENAME",
    "RECEIPT_CHAIN_V1069_HTML_FILENAME",
    "RECEIPT_CHAIN_V1069_JSON_FILENAME",
    "RECEIPT_CHAIN_V1069_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1069_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1069",
