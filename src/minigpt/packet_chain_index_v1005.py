...
from minigpt.packet_chain_check_v1004 import (
    PACKET_CHECK_V1004_JSON_FILENAME,
)
from minigpt.packet_chain_receipt_v1003 import (
    PACKET_RECEIPT_V1003_JSON_FILENAME,
)
...
PACKET_INDEX_V1005_JSON_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_v1005.json"
PACKET_INDEX_V1005_CSV_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_v1005.csv"
PACKET_INDEX_V1005_TEXT_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_v1005.txt"
PACKET_INDEX_V1005_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_v1005.md"
PACKET_INDEX_V1005_HTML_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_v1005.html"
...
def locate_receipt_v1005(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_RECEIPT_V1003_JSON_FILENAME
    return source
...
def locate_receipt_check_v1005(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_CHECK_V1004_JSON_FILENAME
    return source
...
__all__ = [
    "PACKET_INDEX_V1005_CSV_FILENAME",
    "PACKET_INDEX_V1005_HTML_FILENAME",
    "PACKET_INDEX_V1005_JSON_FILENAME",
    "PACKET_INDEX_V1005_MARKDOWN_FILENAME",
    "PACKET_INDEX_V1005_TEXT_FILENAME",
