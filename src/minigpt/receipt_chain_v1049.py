...
from minigpt.receipt_chain_check_v1048 import (
    RECEIPT_CHECK_V1048_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1049_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1049.json"
RECEIPT_CHAIN_V1049_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1049.csv"
RECEIPT_CHAIN_V1049_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1049.txt"
RECEIPT_CHAIN_V1049_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1049.md"
RECEIPT_CHAIN_V1049_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1049.html"
...
def locate_receipt_v1049(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1047_JSON_FILENAME
    return source
...
def locate_receipt_check_v1049(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1048_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1049_CSV_FILENAME",
    "RECEIPT_CHAIN_V1049_HTML_FILENAME",
    "RECEIPT_CHAIN_V1049_JSON_FILENAME",
    "RECEIPT_CHAIN_V1049_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1049_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1049",
