...
RECEIPT_REVIEW_V1070_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1070.json"
RECEIPT_REVIEW_V1070_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1070.csv"
RECEIPT_REVIEW_V1070_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1070.txt"
RECEIPT_REVIEW_V1070_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1070.md"
RECEIPT_REVIEW_V1070_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1070.html"
...
def locate_receipt_index_v1070(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1069_JSON_FILENAME
    return source
...
def build_receipt_review_v1070(
...
__all__ = [
    "RECEIPT_REVIEW_V1070_CSV_FILENAME",
    "RECEIPT_REVIEW_V1070_HTML_FILENAME",
    "RECEIPT_REVIEW_V1070_JSON_FILENAME",
    "RECEIPT_REVIEW_V1070_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1070_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1070",
