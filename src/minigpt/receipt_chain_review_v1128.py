...
RECEIPT_REVIEW_V1128_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1128.json"
RECEIPT_REVIEW_V1128_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1128.csv"
RECEIPT_REVIEW_V1128_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1128.txt"
RECEIPT_REVIEW_V1128_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1128.md"
RECEIPT_REVIEW_V1128_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1128.html"
...
def locate_receipt_index_v1128(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1127_JSON_FILENAME
    return source
...
def build_receipt_review_v1128(
...
__all__ = [
    "RECEIPT_REVIEW_V1128_CSV_FILENAME",
    "RECEIPT_REVIEW_V1128_HTML_FILENAME",
    "RECEIPT_REVIEW_V1128_JSON_FILENAME",
    "RECEIPT_REVIEW_V1128_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1128_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1128",
