...
from minigpt.packet_chain_index_v997 import (
    PACKET_INDEX_V997_CSV_FILENAME,
    PACKET_INDEX_V997_HTML_FILENAME,
    PACKET_INDEX_V997_JSON_FILENAME,
    PACKET_INDEX_V997_MARKDOWN_FILENAME,
    PACKET_INDEX_V997_TEXT_FILENAME,
)
...
def write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_v997_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / PACKET_INDEX_V997_JSON_FILENAME,
        "csv": root / PACKET_INDEX_V997_CSV_FILENAME,
        "text": root / PACKET_INDEX_V997_TEXT_FILENAME,
        "markdown": root / PACKET_INDEX_V997_MARKDOWN_FILENAME,
        "html": root / PACKET_INDEX_V997_HTML_FILENAME,
    }
