...
RECEIPT_REVIEW_V1062_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1062.json"
RECEIPT_REVIEW_V1062_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1062.csv"
RECEIPT_REVIEW_V1062_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1062.txt"
RECEIPT_REVIEW_V1062_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1062.md"
RECEIPT_REVIEW_V1062_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1062.html"
...
def locate_receipt_index_v1062(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1061_JSON_FILENAME
    return source
...
def build_receipt_review_v1062(
...
__all__ = [
    "RECEIPT_REVIEW_V1062_CSV_FILENAME",
    "RECEIPT_REVIEW_V1062_HTML_FILENAME",
    "RECEIPT_REVIEW_V1062_JSON_FILENAME",
    "RECEIPT_REVIEW_V1062_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1062_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1062",
