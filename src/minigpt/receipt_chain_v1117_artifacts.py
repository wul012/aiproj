...
def render_receipt_v1117_artifacts_text(report: dict[str, Any]) -> str:
...
def write_receipt_v1117_artifacts_csv(report: dict[str, Any], path: str | Path) -> None:
...
def render_receipt_v1117_artifacts_markdown(report: dict[str, Any]) -> str:
    summary = as_dict(report.get("summary"))
...
def render_receipt_v1117_artifacts_html(report: dict[str, Any]) -> str:
    summary = as_dict(report.get("summary"))
    receipt = as_dict(report.get("receipt"))
...
def write_receipt_v1117_artifacts_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    root = Path(out_dir)
    ...
    write_receipt_v1117_artifacts_csv(report, paths["csv"])
    paths["text"].write_text(render_receipt_v1117_artifacts_text(report), encoding="utf-8")
    paths["markdown"].write_text(render_receipt_v1117_artifacts_markdown(report), encoding="utf-8")
    paths["html"].write_text(render_receipt_v1117_artifacts_html(report), encoding="utf-8")
...
__all__ = [
    "render_receipt_v1117_artifacts_html",
    "render_receipt_v1117_artifacts_markdown",
    "render_receipt_v1117_artifacts_text",
    "write_receipt_v1117_artifacts_outputs",
]
