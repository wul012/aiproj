...
from minigpt.packet_chain_check_v1008 import (
    PACKET_CHECK_V1008_JSON_FILENAME,
)
from minigpt.packet_chain_receipt_v1007 import (
    PACKET_RECEIPT_V1007_JSON_FILENAME,
)
...
PACKET_INDEX_V1009_JSON_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_v1009.json"
PACKET_INDEX_V1009_CSV_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_v1009.csv"
PACKET_INDEX_V1009_TEXT_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_v1009.txt"
PACKET_INDEX_V1009_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_v1009.md"
PACKET_INDEX_V1009_HTML_FILENAME = "randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_receipt_index_receipt_index_v1009.html"
...
def locate_receipt_v1009(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_RECEIPT_V1007_JSON_FILENAME
    return source
...
def locate_receipt_check_v1009(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / PACKET_CHECK_V1008_JSON_FILENAME
    return source
...
__all__ = [
    "PACKET_INDEX_V1009_CSV_FILENAME",
    "PACKET_INDEX_V1009_HTML_FILENAME",
    "PACKET_INDEX_V1009_JSON_FILENAME",
    "PACKET_INDEX_V1009_MARKDOWN_FILENAME",
    "PACKET_INDEX_V1009_TEXT_FILENAME",
    "build_packet_index_v1009",
