...
from minigpt.ack_bundle_receipt import (
    ACK_BUNDLE_RECEIPT_JSON_FILENAME,
)
...
RECEIPT_REVIEW_JSON_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_review.json"
RECEIPT_REVIEW_CSV_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_review.csv"
RECEIPT_REVIEW_TEXT_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_review.txt"
RECEIPT_REVIEW_MARKDOWN_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_review.md"
RECEIPT_REVIEW_HTML_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_review.html"
...
def locate_receipt_review(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / ACK_BUNDLE_RECEIPT_JSON_FILENAME
    return source
...
__all__ = [
    "RECEIPT_REVIEW_CSV_FILENAME",
    "RECEIPT_REVIEW_HTML_FILENAME",
    "RECEIPT_REVIEW_JSON_FILENAME",
    "RECEIPT_REVIEW_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_TEXT_FILENAME",
