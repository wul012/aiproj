...
from minigpt.randomized_holdout_publication_receipt_index_receipt_check_v1016 import (
    RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_CSV_FILENAME,
    RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_HTML_FILENAME,
    RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_JSON_FILENAME,
    RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_MARKDOWN_FILENAME,
    RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_TEXT_FILENAME,
)
...
def render_randomized_holdout_publication_receipt_index_receipt_check_v1016_text(report: dict[str, Any]) -> str:
...
def write_randomized_holdout_publication_receipt_index_receipt_check_v1016_csv(report: dict[str, Any], path: str | Path) -> None:
...
def render_randomized_holdout_publication_receipt_index_receipt_check_v1016_markdown(report: dict[str, Any]) -> str:
    summary = as_dict(report.get("summary"))
    lines = [
        f"# {markdown_cell(report.get('title', 'MiniGPT randomized holdout publication receipt index receipt check v1016'))}",
        "",
...
def render_randomized_holdout_publication_receipt_index_receipt_check_v1016_html(report: dict[str, Any]) -> str:
    summary = as_dict(report.get("summary"))
...
def write_randomized_holdout_publication_receipt_index_receipt_check_v1016_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    root = Path(out_dir)
    root.mkdir(parents=True, exist_ok=True)
    paths = {
        "json": root / RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_JSON_FILENAME,
        "csv": root / RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_CSV_FILENAME,
        "text": root / RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_TEXT_FILENAME,
        "markdown": root / RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_MARKDOWN_FILENAME,
        "html": root / RANDOMIZED_HOLDOUT_PUBLICATION_RECEIPT_INDEX_RECEIPT_CHECK_V1016_HTML_FILENAME,
    }
    write_json_payload(report, paths["json"])
    write_randomized_holdout_publication_receipt_index_receipt_check_v1016_csv(report, paths["csv"])
    paths["text"].write_text(render_randomized_holdout_publication_receipt_index_receipt_check_v1016_text(report), encoding="utf-8")
    paths["markdown"].write_text(render_randomized_holdout_publication_receipt_index_receipt_check_v1016_markdown(report), encoding="utf-8")
    paths["html"].write_text(render_randomized_holdout_publication_receipt_index_receipt_check_v1016_html(report), encoding="utf-8")
...
__all__ = [
    "render_randomized_holdout_publication_receipt_index_receipt_check_v1016_html",
    "render_randomized_holdout_publication_receipt_index_receipt_check_v1016_markdown",
    "render_randomized_holdout_publication_receipt_index_receipt_check_v1016_text",
    "write_randomized_holdout_publication_receipt_index_receipt_check_v1016_outputs",
]
