...
from minigpt.registry_ack_packet import (
    REGISTRY_ACK_PACKET_JSON_FILENAME,
)
from minigpt.registry_ack_packet_check import (
    ACK_PACKET_CHECK_JSON_FILENAME,
)
...
ACK_PACKET_INDEX_JSON_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt_packet_index.json"
ACK_PACKET_INDEX_CSV_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt_packet_index.csv"
ACK_PACKET_INDEX_TEXT_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt_packet_index.txt"
ACK_PACKET_INDEX_MARKDOWN_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt_packet_index.md"
ACK_PACKET_INDEX_HTML_FILENAME = "randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt_packet_index.html"
...
def locate_randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_packet_index_publication_receipt_packet_index_publication_receipt_packet(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / REGISTRY_ACK_PACKET_JSON_FILENAME
    return source


def locate_ack_packet_index(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / ACK_PACKET_CHECK_JSON_FILENAME
    return source
...
__all__ = [
    "ACK_PACKET_INDEX_CSV_FILENAME",
    "ACK_PACKET_INDEX_HTML_FILENAME",
    "ACK_PACKET_INDEX_JSON_FILENAME",
    "ACK_PACKET_INDEX_MARKDOWN_FILENAME",
    "ACK_PACKET_INDEX_TEXT_FILENAME",
    "build_ack_packet_index",
