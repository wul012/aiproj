...
from minigpt.receipt_chain_check_v1052 import (
    RECEIPT_CHECK_V1052_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1053_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1053.json"
RECEIPT_CHAIN_V1053_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1053.csv"
RECEIPT_CHAIN_V1053_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1053.txt"
RECEIPT_CHAIN_V1053_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1053.md"
RECEIPT_CHAIN_V1053_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1053.html"
...
def locate_receipt_v1053(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1051_JSON_FILENAME
    return source
...
def locate_receipt_check_v1053(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1052_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1053_CSV_FILENAME",
    "RECEIPT_CHAIN_V1053_HTML_FILENAME",
    "RECEIPT_CHAIN_V1053_JSON_FILENAME",
    "RECEIPT_CHAIN_V1053_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1053_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1053",
