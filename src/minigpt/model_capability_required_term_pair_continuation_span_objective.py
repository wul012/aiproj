...
from minigpt.model_capability_required_term_pair_continuation_span_objective_core import (
    ...
    REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_HTML_FILENAME as REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_HTML_FILENAME,
    REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_JSON_FILENAME as REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_JSON_FILENAME,
    REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_MARKDOWN_FILENAME as REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_MARKDOWN_FILENAME,
    REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_TEXT_FILENAME as REQUIRED_TERM_PAIR_CONTINUATION_SPAN_OBJECTIVE_TEXT_FILENAME,
