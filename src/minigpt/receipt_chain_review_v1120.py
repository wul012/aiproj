...
RECEIPT_REVIEW_V1120_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1120.json"
RECEIPT_REVIEW_V1120_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1120.csv"
RECEIPT_REVIEW_V1120_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1120.txt"
RECEIPT_REVIEW_V1120_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1120.md"
RECEIPT_REVIEW_V1120_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1120.html"
...
def locate_receipt_index_v1120(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1119_JSON_FILENAME
    return source
...
def build_receipt_review_v1120(
...
__all__ = [
    "RECEIPT_REVIEW_V1120_CSV_FILENAME",
    "RECEIPT_REVIEW_V1120_HTML_FILENAME",
    "RECEIPT_REVIEW_V1120_JSON_FILENAME",
    "RECEIPT_REVIEW_V1120_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1120_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1120",
