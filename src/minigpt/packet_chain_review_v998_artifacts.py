...
def write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_review_v998_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / PACKET_REVIEW_V998_JSON_FILENAME,
        "csv": root / PACKET_REVIEW_V998_CSV_FILENAME,
        "text": root / PACKET_REVIEW_V998_TEXT_FILENAME,
        "markdown": root / PACKET_REVIEW_V998_MARKDOWN_FILENAME,
        "html": root / PACKET_REVIEW_V998_HTML_FILENAME,
    }
