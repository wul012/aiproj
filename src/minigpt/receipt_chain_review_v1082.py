...
RECEIPT_REVIEW_V1082_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1082.json"
RECEIPT_REVIEW_V1082_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1082.csv"
RECEIPT_REVIEW_V1082_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1082.txt"
RECEIPT_REVIEW_V1082_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1082.md"
RECEIPT_REVIEW_V1082_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1082.html"
...
def locate_receipt_index_v1082(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1081_JSON_FILENAME
    return source
...
def build_receipt_review_v1082(
...
__all__ = [
    "RECEIPT_REVIEW_V1082_CSV_FILENAME",
    "RECEIPT_REVIEW_V1082_HTML_FILENAME",
    "RECEIPT_REVIEW_V1082_JSON_FILENAME",
    "RECEIPT_REVIEW_V1082_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1082_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1082",
