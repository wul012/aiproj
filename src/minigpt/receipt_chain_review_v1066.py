...
RECEIPT_REVIEW_V1066_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1066.json"
RECEIPT_REVIEW_V1066_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1066.csv"
RECEIPT_REVIEW_V1066_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1066.txt"
RECEIPT_REVIEW_V1066_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1066.md"
RECEIPT_REVIEW_V1066_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1066.html"
...
def locate_receipt_index_v1066(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1065_JSON_FILENAME
    return source
...
def build_receipt_review_v1066(
...
__all__ = [
    "RECEIPT_REVIEW_V1066_CSV_FILENAME",
    "RECEIPT_REVIEW_V1066_HTML_FILENAME",
    "RECEIPT_REVIEW_V1066_JSON_FILENAME",
    "RECEIPT_REVIEW_V1066_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1066_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1066",
