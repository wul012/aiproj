...
from minigpt.receipt_chain_check_v1064 import (
    RECEIPT_CHECK_V1064_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1065_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1065.json"
RECEIPT_CHAIN_V1065_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1065.csv"
RECEIPT_CHAIN_V1065_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1065.txt"
RECEIPT_CHAIN_V1065_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1065.md"
RECEIPT_CHAIN_V1065_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1065.html"
...
def locate_receipt_v1065(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1063_JSON_FILENAME
    return source
...
def locate_receipt_check_v1065(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1064_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1065_CSV_FILENAME",
    "RECEIPT_CHAIN_V1065_HTML_FILENAME",
    "RECEIPT_CHAIN_V1065_JSON_FILENAME",
    "RECEIPT_CHAIN_V1065_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1065_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1065",
