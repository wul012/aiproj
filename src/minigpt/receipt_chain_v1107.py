...
from minigpt.receipt_chain_check_v1106 import (
    RECEIPT_CHECK_V1106_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1107_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1107.json"
RECEIPT_CHAIN_V1107_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1107.csv"
RECEIPT_CHAIN_V1107_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1107.txt"
RECEIPT_CHAIN_V1107_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1107.md"
RECEIPT_CHAIN_V1107_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1107.html"
...
def locate_receipt_check_v1107(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1106_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1107_CSV_FILENAME",
    "RECEIPT_CHAIN_V1107_HTML_FILENAME",
    "RECEIPT_CHAIN_V1107_JSON_FILENAME",
    "RECEIPT_CHAIN_V1107_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1107_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1107",
