...
from minigpt.packet_chain_receipt_v999 import (
    PACKET_RECEIPT_V999_CSV_FILENAME,
    PACKET_RECEIPT_V999_HTML_FILENAME,
    PACKET_RECEIPT_V999_JSON_FILENAME,
    PACKET_RECEIPT_V999_MARKDOWN_FILENAME,
    PACKET_RECEIPT_V999_TEXT_FILENAME,
)
...
def write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_v999_outputs(report: dict[str, Any], out_dir: str | Path) -> dict[str, str]:
    ...
    paths = {
        "json": root / PACKET_RECEIPT_V999_JSON_FILENAME,
        "csv": root / PACKET_RECEIPT_V999_CSV_FILENAME,
        "text": root / PACKET_RECEIPT_V999_TEXT_FILENAME,
        "markdown": root / PACKET_RECEIPT_V999_MARKDOWN_FILENAME,
        "html": root / PACKET_RECEIPT_V999_HTML_FILENAME,
    }
