...
from minigpt.receipt_chain_check_v1092 import (
    RECEIPT_CHECK_V1092_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1093_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1093.json"
RECEIPT_CHAIN_V1093_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1093.csv"
RECEIPT_CHAIN_V1093_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1093.txt"
RECEIPT_CHAIN_V1093_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1093.md"
RECEIPT_CHAIN_V1093_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1093.html"
...
def locate_receipt_check_v1093(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1092_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1093_CSV_FILENAME",
    "RECEIPT_CHAIN_V1093_HTML_FILENAME",
    "RECEIPT_CHAIN_V1093_JSON_FILENAME",
    "RECEIPT_CHAIN_V1093_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1093_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1093",
