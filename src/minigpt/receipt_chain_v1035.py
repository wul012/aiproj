...
from minigpt.receipt_chain_review_v1034 import (
    RECEIPT_REVIEW_V1034_JSON_FILENAME,
...
RECEIPT_CHAIN_V1035_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1035.json"
RECEIPT_CHAIN_V1035_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1035.csv"
RECEIPT_CHAIN_V1035_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1035.txt"
RECEIPT_CHAIN_V1035_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1035.md"
RECEIPT_CHAIN_V1035_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_v1035.html"
...
def locate_receipt_index_review_v1035(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_REVIEW_V1034_JSON_FILENAME
    return source
...
__all__ = [
    ...
    "RECEIPT_CHAIN_V1035_CSV_FILENAME",
    "RECEIPT_CHAIN_V1035_HTML_FILENAME",
    "RECEIPT_CHAIN_V1035_JSON_FILENAME",
    "RECEIPT_CHAIN_V1035_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1035_TEXT_FILENAME",
    "READY_KEY",
    "RECEIPT_STATUS",
    "build_receipt_chain_v1035",
