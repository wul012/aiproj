...
from minigpt.receipt_chain_check_v1102 import (
    RECEIPT_CHECK_V1102_JSON_FILENAME,
)
...
RECEIPT_CHAIN_V1103_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1103.json"
RECEIPT_CHAIN_V1103_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1103.csv"
RECEIPT_CHAIN_V1103_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1103.txt"
RECEIPT_CHAIN_V1103_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1103.md"
RECEIPT_CHAIN_V1103_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_v1103.html"
...
def locate_receipt_check_v1103(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHECK_V1102_JSON_FILENAME
    return source
...
__all__ = [
    "LOOKUP_KEY_PREFIX",
    "RECEIPT_CHAIN_V1103_CSV_FILENAME",
    "RECEIPT_CHAIN_V1103_HTML_FILENAME",
    "RECEIPT_CHAIN_V1103_JSON_FILENAME",
    "RECEIPT_CHAIN_V1103_MARKDOWN_FILENAME",
    "RECEIPT_CHAIN_V1103_TEXT_FILENAME",
    "READY_KEY",
    "build_receipt_chain_v1103",
