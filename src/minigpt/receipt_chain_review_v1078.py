...
RECEIPT_REVIEW_V1078_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1078.json"
RECEIPT_REVIEW_V1078_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1078.csv"
RECEIPT_REVIEW_V1078_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1078.txt"
RECEIPT_REVIEW_V1078_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1078.md"
RECEIPT_REVIEW_V1078_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1078.html"
...
def locate_receipt_index_v1078(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1077_JSON_FILENAME
    return source
...
def build_receipt_review_v1078(
...
__all__ = [
    "RECEIPT_REVIEW_V1078_CSV_FILENAME",
    "RECEIPT_REVIEW_V1078_HTML_FILENAME",
    "RECEIPT_REVIEW_V1078_JSON_FILENAME",
    "RECEIPT_REVIEW_V1078_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1078_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1078",
