...
RECEIPT_REVIEW_V1086_JSON_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1086.json"
RECEIPT_REVIEW_V1086_CSV_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1086.csv"
RECEIPT_REVIEW_V1086_TEXT_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1086.txt"
RECEIPT_REVIEW_V1086_MARKDOWN_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1086.md"
RECEIPT_REVIEW_V1086_HTML_FILENAME = "randomized_holdout_publication_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_receipt_index_review_v1086.html"
...
def locate_receipt_index_v1086(path: str | Path) -> Path:
    source = Path(path)
    if source.is_dir():
        source = source / RECEIPT_CHAIN_V1085_JSON_FILENAME
    return source
...
def build_receipt_review_v1086(
...
__all__ = [
    "RECEIPT_REVIEW_V1086_CSV_FILENAME",
    "RECEIPT_REVIEW_V1086_HTML_FILENAME",
    "RECEIPT_REVIEW_V1086_JSON_FILENAME",
    "RECEIPT_REVIEW_V1086_MARKDOWN_FILENAME",
    "RECEIPT_REVIEW_V1086_TEXT_FILENAME",
    "READY_KEY",
    "REVIEW_STATUS",
    "build_receipt_review_v1086",
