...
def training_section(train_config: dict[str, Any], manifest: dict[str, Any], history_summary: dict[str, Any]) -> dict[str, Any]:
...
def data_section(train_config: dict[str, Any], manifest: dict[str, Any]) -> dict[str, Any]:
...
def sample_section(path: Path) -> dict[str, Any]:
    if not path.exists():
...
def evaluation_section(report: dict[str, Any], path: Path) -> dict[str, Any]:
...
def quality_section(report: dict[str, Any], path: Path) -> dict[str, Any]:
...
def scorecard_section(report: dict[str, Any], path: Path) -> dict[str, Any]:
    summary = _dict(report.get("summary"))
    return {
        "exists": path.exists(),
        "path": str(path),
