...
from minigpt.packet_chain_review_v998_artifacts import (
...
from minigpt.packet_chain_index_v997 import build_packet_index_v997
from minigpt.packet_chain_index_v997_artifacts import write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_v997_outputs
...
from tests.test_packet_chain_index_v997 import ready_index_inputs as ready_receipt_index_inputs
...
class RandomizedHoldoutPublicationReceiptPacketIndexPublicationReceiptIndexReceiptIndexPublicationIndexReceiptIndexReviewV998Tests(unittest.TestCase):
    ...
    def test_cli_require_review_ready_returns_one_on_tampered_index(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((root / "cli-review" / PACKET_REVIEW_V998_JSON_FILENAME).is_file())
    ...
    def test_outputs_and_cli_are_wired(self) -> None:
        ...
        self.assertTrue(outputs["json"].endswith(PACKET_REVIEW_V998_JSON_FILENAME))
