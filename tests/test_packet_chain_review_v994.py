...
from minigpt.packet_chain_review_v994_artifacts import (
...
from minigpt.packet_chain_index_v993_artifacts import write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_v993_outputs
...
class RandomizedHoldoutPublicationReceiptPacketIndexPublicationReceiptIndexReceiptIndexPublicationIndexReviewV994Tests(unittest.TestCase):
    def test_publication_index_review_accepts_ready_index(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            report = build_packet_review_v994(index, publication_index_path=index_path)
    ...
    def test_cli_require_review_ready_returns_one_on_tampered_index(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((root / "cli-review" / PACKET_REVIEW_V994_JSON_FILENAME).is_file())
    ...
    def test_outputs_and_cli_are_wired(self) -> None:
        ...
        self.assertTrue(outputs["json"].endswith(PACKET_REVIEW_V994_JSON_FILENAME))
