...
class PromotedTrainingScaleSeedHandoffReceiptTests(unittest.TestCase):
    ...
    def test_execute_script_can_write_handoff_assurance_outputs(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(assurance_payload["embedded_receipt_check_receipt_schema_version"], 3)
            self.assertEqual(
    ...
    def test_handoff_assurance_exposes_v2_receipt_ci_regression_contract(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertEqual(check["status"], "pass")
            self.assertEqual(check["embedded_receipt_check_receipt_schema_version"], 3)
            ...
            self.assertIn("handoff_assurance_embedded_receipt_check_receipt_schema_version=3", rendered)
            self.assertIn(
