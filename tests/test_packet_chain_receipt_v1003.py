...
from minigpt.packet_chain_receipt_v1003_artifacts import (
...
from minigpt.packet_chain_review_v1002 import build_packet_review_v1002
from minigpt.packet_chain_review_v1002_artifacts import write_randomized_holdout_publication_receipt_packet_index_publication_receipt_index_receipt_index_publication_index_receipt_index_receipt_index_review_v1002_outputs
from minigpt.report_utils import write_json_payload
from scripts.record_packet_chain_receipt_v1003 import main as cli_main
from tests.test_packet_chain_review_v1002 import ready_review_inputs
...
class RandomizedHoldoutPublicationReceiptPacketIndexPublicationReceiptIndexReceiptIndexPublicationIndexReceiptIndexReceiptIndexReceiptV1003Tests(unittest.TestCase):
    def test_receipt_accepts_ready_review(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            report = build_packet_receipt_v1003(
                review,
    ...
    def test_cli_require_receipt_ready_returns_one_on_bad_review(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            self.assertTrue((root / "cli-receipt" / PACKET_RECEIPT_V1003_JSON_FILENAME).is_file())
    ...
    def test_outputs_and_cli_are_wired(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            cli_main([str(review_path.parent), "--out-dir", str(root / "cli-receipt"), "--require-receipt-ready", "--force"])
            cli_report = read_json_report(root / "cli-receipt" / PACKET_RECEIPT_V1003_JSON_FILENAME)

        self.assertEqual(set(outputs), {"json", "csv", "text", "markdown", "html"})
        self.assertTrue(outputs["json"].endswith(PACKET_RECEIPT_V1003_JSON_FILENAME))
...
def ready_receipt_inputs(root: Path) -> tuple[dict[str, object], Path]:
    ...
    review = build_packet_review_v1002(
        index,
