...
class BenchmarkScorecardComparisonArtifactSplitTests(unittest.TestCase):
    def test_artifact_module_writes_outputs_from_comparison_report(self) -> None:
        report = {
            ...
            "baseline": {"name": "base"},
            "runs": [
                {"name": "base", "run_dir": "runs/base", "overall_score": 80, "rubric_avg_score": 70, "case_count": 1, "weakest_rubric_case": "qa", "weakest_rubric_score": 70, "rubric_pass_count": 0, "rubric_warn_count": 1, "rubric_fail_count": 0},
                {"name": "candidate", "run_dir": "runs/candidate", "overall_score": 86, "rubric_avg_score": 82, "case_count": 1, "weakest_rubric_case": "qa", "weakest_rubric_score": 82, "rubric_pass_count": 1, "rubric_warn_count": 0, "rubric_fail_count": 0},
            ],
            "baseline_deltas": [
                {"name": "base", "baseline_name": "base", "is_baseline": True, "overall_score_delta": 0, "rubric_avg_score_delta": 0, "rubric_relation": "baseline", "overall_relation": "baseline", "explanation": "baseline"},
                {"name": "candidate", "baseline_name": "base", "is_baseline": False, "overall_score_delta": 6, "rubric_avg_score_delta": 12, "rubric_relation": "improved", "overall_relation": "improved", "explanation": "improved"},
            ],
            "case_deltas": [
            ...
            "difficulty_deltas": [],
            "summary": {"improved_overall_count": 1, "regressed_overall_count": 0, "improved_rubric_count": 1, "regressed_rubric_count": 0, "case_regression_count": 0, "case_improvement_count": 1, "weakest_case_regression": None},
