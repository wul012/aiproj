...
from minigpt.model_capability_route_promotion_release_packet import (  # noqa: E402
...
from minigpt.model_capability_route_promotion_release_packet_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a route-promotion release packet.")
    ...
    parser.add_argument("--gate", type=Path, required=True, help="Route promotion gate JSON or output directory.")
    parser.add_argument("--out-dir", type=Path, default=ROOT / "runs" / "model-capability-route-promotion-release-packet")
    parser.add_argument("--require-pass", action="store_true", help="Return exit code 1 when packet checks fail.")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    gate_path = locate_route_promotion_gate(args.gate)
    ...
    outputs = write_model_capability_route_promotion_release_packet_outputs(report, args.out_dir)
    print(render_model_capability_route_promotion_release_packet_text(report), end="")
