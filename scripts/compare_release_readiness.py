...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    print(
        ...
        + json.dumps(summary.get("ci_workflow_archived_path_portability_check_ready_changed_count", 0), ensure_ascii=False)
    )
    print(
        "ci_workflow_archived_path_portability_check_ready_regression_count="
        + json.dumps(summary.get("ci_workflow_archived_path_portability_check_ready_regression_count", 0), ensure_ascii=False)
    )
    print(
