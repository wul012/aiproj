...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--pair-baseline-checkpoint", type=Path, default=None, help="Optional baseline checkpoint for every variant pair comparison.")
    parser.add_argument("--pair-baseline-tokenizer", type=Path, default=None, help="Optional tokenizer for --pair-baseline-checkpoint.")
    parser.add_argument("--pair-baseline-id", type=str, default=None, help="Display id for the batch-level pair baseline side.")
    parser.add_argument("--pair-candidate-id", type=str, default=None, help="Display id for the batch-level candidate side; variants may override it.")
