...
def main() -> None:
    ...
    print(
        ...
        + json.dumps(overview.get("release_readiness_ci_tiny_plan_digest_gate_ready_regression_count"), ensure_ascii=False)
    )
    print(
        "release_readiness_ci_boundary_gate_check_ready_regression_count="
        + json.dumps(overview.get("release_readiness_ci_boundary_gate_check_ready_regression_count"), ensure_ascii=False)
    )
    print(
        "release_readiness_ci_boundary_plan_check_ready_regression_count="
        + json.dumps(overview.get("release_readiness_ci_boundary_plan_check_ready_regression_count"), ensure_ascii=False)
    )
    print(
        "release_readiness_ci_drift_smoke_ready_regression_count="
        + json.dumps(overview.get("release_readiness_ci_drift_smoke_ready_regression_count"), ensure_ascii=False)
    )
    ...
    print(f"release_readiness_benchmark_suite_design_delta_count={overview.get('release_readiness_benchmark_suite_design_delta_count')}")
    print(f"release_readiness_benchmark_suite_design_regression_count={overview.get('release_readiness_benchmark_suite_design_regression_count')}")
    print(f"release_readiness_benchmark_design_change_delta_count={overview.get('release_readiness_benchmark_design_change_delta_count')}")
    print(f"release_readiness_max_benchmark_suite_design_delta={overview.get('release_readiness_max_benchmark_suite_design_delta')}")
    print(f"release_readiness_max_benchmark_design_change_delta={overview.get('release_readiness_max_benchmark_design_change_delta')}")
    ...
    print(
        ...
        + json.dumps(overview.get("release_readiness_benchmark_requirement_failed_reason_mixed_delta_count"), ensure_ascii=False)
    )
    print(
