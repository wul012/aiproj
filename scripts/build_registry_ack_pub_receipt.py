...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    review_path = locate_ack_pub_receipt(args.index_review)
    ...
    outputs = write_pub_receipt_artifacts_outputs(report, args.out_dir)
    print(render_pub_receipt_artifacts_text(report), end="")
