"""v1289 Phase B: CPU-only verdict + artifacts from the Phase-A cache and the
read-only committed v1287 cache (zero retrain).

Example:
    python scripts/analyze_grok_spike_microscopy_v1289.py
"""
...
STEM = "grok_spike_microscopy_v1289"


def main(argv=None) -> None:
    parser = argparse.ArgumentParser(description="v1289 Phase B analyzer")
    parser.add_argument("--cache", type=Path,
                        default=ROOT / "output" / "grok-spike-microscopy-v1289" / "phase_a_cache.pt")
