...
from minigpt.model_capability_required_term_pair_colon_immediate_missed_seed_diagnostic_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Diagnose colon-immediate missed seeds with first-token logits.")
    parser.add_argument("stability_report", type=Path, help="v536 stability JSON or its output directory.")
    parser.add_argument("--out-dir", type=Path, default=ROOT / "runs" / "model-capability-required-term-pair-colon-immediate-missed-seed-diagnostic")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    outputs = write_model_capability_required_term_pair_colon_immediate_missed_seed_diagnostic_outputs(report, args.out_dir)
    print(render_model_capability_required_term_pair_colon_immediate_missed_seed_diagnostic_text(report), end="")
