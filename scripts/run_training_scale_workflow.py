...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--suite", type=Path, default=None, help="Optional prompt suite JSON for the workflow plan and batch handoff.")
    parser.add_argument("--suite-name", choices=["default", "standard-zh"], default=None, help="Use a built-in prompt suite for the workflow plan and batch handoff.")
