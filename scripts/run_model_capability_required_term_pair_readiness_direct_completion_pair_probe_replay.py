...
from minigpt.model_capability_required_term_pair_readiness_direct_completion_pair_probe_replay import (  # noqa: E402
...
from minigpt.model_capability_required_term_pair_readiness_direct_completion_pair_probe_replay_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Replay a selected direct-completion route on heldout pair prompt surfaces.")
    parser.add_argument("route_comparison", type=Path, help="Direct-completion route comparison JSON or output directory.")
    parser.add_argument("--out-dir", type=Path, default=ROOT / "runs" / "model-capability-required-term-pair-readiness-direct-completion-pair-probe-replay")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    source = locate_direct_completion_pair_probe_replay_source(args.route_comparison)
    ...
    outputs = write_direct_completion_pair_probe_replay_outputs(report, args.out_dir)
    print(render_direct_completion_pair_probe_replay_text(report), end="")
