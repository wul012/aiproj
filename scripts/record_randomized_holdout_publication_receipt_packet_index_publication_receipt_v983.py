...
from minigpt.randomized_holdout_publication_receipt_packet_index_publication_receipt_v983 import (  # noqa: E402
    build_randomized_holdout_publication_receipt_packet_index_publication_receipt_v983,
    locate_publication_index_review_v983,
    read_json_report,
    resolve_exit_code,
)
from minigpt.randomized_holdout_publication_receipt_packet_index_publication_receipt_v983_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Record a randomized holdout publication receipt packet index publication receipt v983.")
    parser.add_argument("index_review", type=Path, help="Publication index review JSON or output directory.")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    review_path = locate_publication_index_review_v983(args.index_review)
    ...
    outputs = write_randomized_holdout_publication_receipt_packet_index_publication_receipt_v983_outputs(report, args.out_dir)
    print(render_randomized_holdout_publication_receipt_packet_index_publication_receipt_v983_text(report), end="")
