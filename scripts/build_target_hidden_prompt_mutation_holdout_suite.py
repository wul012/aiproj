...
from minigpt.target_hidden_prompt_mutation_holdout_suite import (  # noqa: E402
...
from minigpt.target_hidden_prompt_mutation_holdout_suite_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build a tokenizer-covered prompt-mutation target-hidden holdout suite.")
    ...
    parser.add_argument("--out-dir", type=Path, default=ROOT / "runs" / "target-hidden-prompt-mutation-holdout-suite")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    outputs = write_target_hidden_prompt_mutation_holdout_suite_outputs(report, args.out_dir)
    print(render_target_hidden_prompt_mutation_holdout_suite_text(report), end="")
