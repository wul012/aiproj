...
def main() -> None:
    ...
    if governance_report is not None:
        ...
        print(f"governance_core_value_count={governance_summary['core_value_count']}")
        print(f"governance_supporting_value_count={governance_summary['supporting_value_count']}")
        print(f"governance_watch_value_count={governance_summary['watch_value_count']}")
        print(f"governance_low_duplicate_risk_count={governance_summary['low_duplicate_risk_count']}")
        print(f"governance_medium_duplicate_risk_count={governance_summary['medium_duplicate_risk_count']}")
        print(f"governance_high_duplicate_risk_count={governance_summary['high_duplicate_risk_count']}")
        print(f"governance_heavy_recent_expansion_count={governance_summary['heavy_recent_expansion_count']}")
        print(f"governance_freeze_new_fields_count={governance_summary['freeze_new_fields_count']}")
