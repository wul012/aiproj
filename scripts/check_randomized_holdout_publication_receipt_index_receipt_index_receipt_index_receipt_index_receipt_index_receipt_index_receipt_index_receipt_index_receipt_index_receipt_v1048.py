...
from minigpt.receipt_chain_check_v1048 import (  # noqa: E402
    build_receipt_check_v1048,
    locate_receipt_v1048,
    read_json_report,
    resolve_exit_code,
)
from minigpt.receipt_chain_check_v1048_artifacts import (  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    outputs = write_check_v1048_artifacts_outputs(report, args.out_dir)
    print(render_check_v1048_artifacts_text(report), end="")
