...
from minigpt.model_capability_required_term_pair_rebalance_seed_stability import (  # noqa: E402
...
from minigpt.model_capability_required_term_pair_rebalance_seed_stability_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Repeat v495 full-hit rebalance pairs across seeds.")
    parser.add_argument("pair_rebalance", type=Path, help="Path to v495 pair-rebalance JSON or directory.")
    parser.add_argument(
        "--out-dir",
        type=Path,
        default=ROOT / "runs" / "model-capability-required-term-pair-rebalance-seed-stability",
    )
    parser.add_argument("--seeds", default="496,1496,2496", help="Comma-separated training/generation seeds.")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    source = locate_model_capability_required_term_pair_rebalance_seed_stability_source(args.pair_rebalance)
    ...
    outputs = write_model_capability_required_term_pair_rebalance_seed_stability_outputs(report, args.out_dir)
    print(render_model_capability_required_term_pair_rebalance_seed_stability_text(report), end="")
