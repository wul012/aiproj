...
from minigpt.randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt import (  # noqa: E402
...
from minigpt.randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Record a downstream consumer receipt for a randomized holdout ack bundle publication index review.")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    review_path = locate_randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_index_review(args.index_review)
    ...
    outputs = write_randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_outputs(report, args.out_dir)
    print(render_randomized_holdout_publication_registry_downstream_consumer_ack_bundle_publication_receipt_text(report), end="")
