...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    outputs = write_model_capability_required_term_pair_colon_immediate_stability_outputs(report, args.out_dir)
    print(render_model_capability_required_term_pair_colon_immediate_stability_text(report), end="")
