...
def main() -> None:
    ...
    print(f"generation_quality_total_flags={summary.get('generation_quality_total_flags')}")
    print(f"generation_quality_dominant_flag={summary.get('generation_quality_dominant_flag')}")
    print(f"generation_quality_worst_case={summary.get('generation_quality_worst_case')}")
