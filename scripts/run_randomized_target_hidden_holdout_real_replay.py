...
from minigpt.randomized_target_hidden_holdout_real_replay import (  # noqa: E402
...
from minigpt.randomized_target_hidden_holdout_real_replay_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run real replay for the randomized target-hidden holdout suite.")
    ...
    parser.add_argument("--out-dir", type=Path, default=ROOT / "runs" / "randomized-target-hidden-holdout-real-replay")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    dry_run_path = locate_randomized_target_hidden_holdout_dry_run(args.dry_run)
    ...
    outputs = write_randomized_target_hidden_holdout_real_replay_outputs(report, args.out_dir)
    print(render_randomized_target_hidden_holdout_real_replay_text(report), end="")
