...
from minigpt.model_capability_route_promotion_bounded_objective_decoder_anchor_policy_replay import (  # noqa: E402
...
from minigpt.model_capability_route_promotion_bounded_objective_decoder_anchor_policy_replay_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Replay a guarded bounded objective decoder anchor policy.")
    ...
    parser.add_argument("--decoder-anchor-policy", type=Path, required=True, help="Bounded objective decoder anchor policy JSON or output directory.")
    ...
    parser.add_argument("--out-dir", type=Path, default=ROOT / "runs" / "model-capability-route-promotion-bounded-objective-decoder-anchor-policy-replay")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    outputs = write_bounded_objective_decoder_anchor_policy_replay_outputs(report, args.out_dir)
    print(render_bounded_objective_decoder_anchor_policy_replay_text(report), end="")
