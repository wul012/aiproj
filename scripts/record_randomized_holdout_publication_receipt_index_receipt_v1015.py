...
from minigpt.randomized_holdout_publication_receipt_index_receipt_v1015 import (  # noqa: E402
...
from minigpt.randomized_holdout_publication_receipt_index_receipt_v1015_artifacts import (  # noqa: E402
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Record a randomized holdout publication receipt index receipt v1015.")
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    review_path = locate_receipt_index_review_v1015(args.receipt_index_review)
    ...
    outputs = write_randomized_holdout_publication_receipt_index_receipt_v1015_outputs(report, args.out_dir)
    print(render_randomized_holdout_publication_receipt_index_receipt_v1015_text(report), end="")
