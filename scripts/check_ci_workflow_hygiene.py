...
def main(argv: list[str] | None = None) -> int:
    ...
    print(f"type_analysis_present={summary['type_analysis_present']}")
    print(f"type_analysis_order_ready={summary['type_analysis_order_ready']}")
    print(f"type_analysis_ready={summary['type_analysis_ready']}")
    print(f"file_size_ratchet_present={summary['file_size_ratchet_present']}")
    print(f"file_size_ratchet_order_ready={summary['file_size_ratchet_order_ready']}")
    print(f"file_size_ratchet_ready={summary['file_size_ratchet_ready']}")
    print(f"aiproj_track_closeout_present={summary['aiproj_track_closeout_present']}")
    print(f"aiproj_track_closeout_order_ready={summary['aiproj_track_closeout_order_ready']}")
    print(f"aiproj_track_closeout_ready={summary['aiproj_track_closeout_ready']}")
