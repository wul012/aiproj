...
from minigpt.receipt_chain_v1105 import (  # noqa: E402
...
from minigpt.receipt_chain_v1105_artifacts import (  # noqa: E402
...
def main(argv: Sequence[str] | None = None) -> None:
    ...
    outputs = write_receipt_v1105_artifacts_outputs(report, args.out_dir)
    print(render_receipt_v1105_artifacts_text(report), end="")
