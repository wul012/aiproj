...
- 本目录保留 v303-v472 的训练治理阶段讲解；从 v473 开始，模型能力阶段讲解写入同级 `代码讲解记录_模型能力阶段/`。
...
本目录让 MiniGPT 的文档治理从“继续向一个成熟度目录堆版本”转为“阶段化同级承接”；v303-v472 的训练治理记录在这里收口，v473 之后的模型能力阶段由同级新目录承接。
