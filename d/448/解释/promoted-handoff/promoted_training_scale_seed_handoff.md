...
- Generated: `2026-05-27T00:24:05Z`
...
- Automation gate: `not-required`
- Automation gate decision: `not-requested`
- Automation gate exit code: `0`
- Automation gate required count: `0`
- Automation gate blocking count: `0`
- Automation gate detail: `no seed handoff automation requirements were requested`
...
- Receipt check receipt path: `d\448\解释\promoted-handoff\promoted_training_scale_seed_handoff_automation_receipt.json`
- Receipt check json: `d\448\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.json`
- Receipt check text: `d\448\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.txt`
...
- Embedded receipt check receipt path: `d\448\解释\promoted-handoff\promoted_training_scale_seed_handoff_automation_receipt.json`
- Embedded receipt check receipt path exists: `True`
- Embedded receipt check json: `d\448\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.json`
- Embedded receipt check json exists: `True`
- Embedded receipt check text: `d\448\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.txt`
- Embedded receipt check text exists: `True`
- Embedded receipt check output json: `d\448\解释\embedded-receipt-check\promoted_training_scale_seed_handoff_embedded_receipt_check.json`
- Embedded receipt check output text: `d\448\解释\embedded-receipt-check\promoted_training_scale_seed_handoff_embedded_receipt_check.txt`
...
- Handoff assurance receipt CI regressions: `2`
- Handoff assurance receipt CI boundary plan-check regressions: `1`
...
- Handoff assurance receipt comparison exclusions: `['handoff batch CI regression count is 2']`
...
- Handoff assurance json: `d\448\解释\handoff-assurance\promoted_training_scale_seed_handoff_assurance.json`
- Handoff assurance text: `d\448\解释\handoff-assurance\promoted_training_scale_seed_handoff_assurance.txt`
...
| Key | Exists | Path |
| --- | --- | --- |
| training_scale_plan_json | False | D:\aiproj\d\448\解释\promoted-plan\training_scale_plan.json |
| training_scale_variants_json | False | D:\aiproj\d\448\解释\promoted-plan\training_scale_variants.json |
| training_scale_plan_csv | False | D:\aiproj\d\448\解释\promoted-plan\training_scale_plan.csv |
| training_scale_plan_markdown | False | D:\aiproj\d\448\解释\promoted-plan\training_scale_plan.md |
| training_scale_plan_html | False | D:\aiproj\d\448\解释\promoted-plan\training_scale_plan.html |

## Recommendations

- Suite alignment is pending plan generation; execute the seed handoff before treating the plan suite as confirmed.
- Rejected promoted decision inputs include handoff batch CI regressions caused by boundary plan-check readiness; keep them out of the seed handoff baseline. Boundary plan regressions: 1.
