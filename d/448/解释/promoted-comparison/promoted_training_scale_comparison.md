...
- Generated: `2026-05-27T00:20:59Z`
...
| --- | --- | --- | ---: | --- | ---: | --- | --- | ---: | ---: | --- | --- | --- | ---: | --- |
| alpha | promoted | True | 90 | consistent | 0 | True | clean |  |  |  | builtin:standard-zh | blocker | 1 | d\448\解释\fixture\promotion-index\..\runs\alpha\training_scale_run.json |
| beta-boundary-plan | promoted | False |  | consistent | 0 | True | clean | 2 |  | handoff batch CI regression count is 2 | builtin:standard-zh | review | 0 | d\448\解释\fixture\promotion-index\..\runs\beta\training_scale_run.json |
| gamma | promoted | True | 107 | consistent | 0 | False |  |  |  |  | builtin:standard-zh | review | 0 | d\448\解释\fixture\promotion-index\..\runs\gamma\training_scale_run.json |
...
- CI-regressed handoff batch evidence remains visible in the promotion list but is kept out of clean-required promoted comparisons. Observed reasons: boundary_gate_plan_check_not_ready:1, workflow-order-regressed:1.
