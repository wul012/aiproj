# MiniGPT v466 archived path maturity narrative

- Generated: `2026-05-27T14:33:58Z`
- Project root: `.`
...
| Release CI regression reasons | archived_path_portability_check_not_ready:1 |
| Release CI tiny plan regressions | 0 |
| Release CI boundary gate regressions | 0 |
| Release CI boundary plan regressions | 0 |
| Release CI archived path regressions | 1 |
...
- Status: `warn`
- Claim: MiniGPT is at v465 with maturity level 4.5.
...
| --- | --- | --- | --- | --- |
| maturity | warn | d\466\解释\maturity-summary-archived-path\maturity_summary.json | project maturity | MiniGPT is at v465 with maturity level 4.5. |
| release quality | ci-regressed | d\466\解释\registry-archived-path\registry.json | release readiness trend | Release readiness trend is ci-regressed with 0 regression(s) and 0 improvement(s); CI workflow regressions=1, CI order regressions=0, CI regression reasons=archived_path_portability_check_not_ready:1, CI boundary plan regressions=0, CI archived path regressions=1, max order violation delta=0, test coverage regressions=0, max coverage gap delta=0, benchmark-history regressions=0, max benchmark case-regression delta=0, benchmark boundary changes=0, benchmark suite-design deltas=0, suite-design regressions=0, design changes=0, max suite-design delta=0, max design-change delta=0, benchmark requirement changes=0, benchmark requirement exit delta=0, benchmark failed reasons added=0 (none), removed=0 (none), recovery deltas=0, mixed deltas=0. |
| serving | missing | runs\request-history-summary\request_history_summary.json | request history stability | Request history status is missing across 0 local inference records. |
