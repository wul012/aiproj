...
- Left: tiny-baseline (d\438\解释\baseline-candidate-threshold-boundary-smoke\tiny-scorecard-comparison-smoke\candidate\run\checkpoint.pt)
- Right: tiny-repeat (d\438\解释\baseline-candidate-threshold-boundary-smoke\tiny-scorecard-comparison-smoke\candidate\run\checkpoint.pt)
- Cases: 10
- Generated equal: 10
