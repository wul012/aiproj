...
- Readiness failed reasons: `insufficient_ready_entries, not_real_benchmark_evidence`
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| tiny-scorecard-smoke | tiny-baseline | tiny-candidate | blocked | blocked | pass | pass | 0.0 | 0 | 0 | tiny-smoke-plumbing-evidence |
