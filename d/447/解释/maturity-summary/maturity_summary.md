# MiniGPT project maturity summary

- Generated: `2026-05-26T13:41:54Z`
...
| Release readiness CI regression reasons | boundary_gate_plan_check_not_ready:1 |
| Release readiness CI tiny plan regressions | 0 |
| Release readiness CI boundary gate regressions | 0 |
| Release readiness CI boundary plan regressions | 1 |
...
| CI boundary plan regressions | 1 |
...
| Max benchmark case-regression delta |  |
...
- Review CI workflow hygiene regressions (boundary_gate_plan_check_not_ready:1) before presenting the project as release-stable; maturity status is downgraded to review.
