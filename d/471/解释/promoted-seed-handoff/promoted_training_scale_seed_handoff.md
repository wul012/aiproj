...
- Generated: `2026-05-28T08:23:10Z`
...
- Receipt check receipt path: `d\471\解释\promoted-seed-handoff\promoted_training_scale_seed_handoff_automation_receipt.json`
- Receipt check json: `d\471\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.json`
- Receipt check text: `d\471\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.txt`
...
- Embedded receipt check receipt path: `d\471\解释\promoted-seed-handoff\promoted_training_scale_seed_handoff_automation_receipt.json`
- Embedded receipt check receipt path exists: `True`
- Embedded receipt check json: `d\471\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.json`
- Embedded receipt check json exists: `True`
- Embedded receipt check text: `d\471\解释\receipt-check\promoted_training_scale_seed_handoff_automation_receipt_check.txt`
- Embedded receipt check text exists: `True`
- Embedded receipt check output json: `d\471\解释\embedded-receipt-check\promoted_training_scale_seed_handoff_embedded_receipt_check.json`
- Embedded receipt check output text: `d\471\解释\embedded-receipt-check\promoted_training_scale_seed_handoff_embedded_receipt_check.txt`
...
- Handoff assurance receipt schema version: `5`
- Handoff assurance receipt selected CI regressions: `1`
- Handoff assurance receipt selected CI reasons: `archived_path_portability_check_not_ready:1`
- Handoff assurance receipt selected CI boundary plan-check regressions: `1`
- Handoff assurance receipt CI regressions: `2`
- Handoff assurance receipt CI reasons: `archived_path_portability_check_not_ready:1, workflow-order-regressed:1`
...
- Handoff assurance receipt ready CI reasons: `none`
...
- Handoff assurance json: `d\471\解释\handoff-assurance\promoted_training_scale_seed_handoff_assurance.json`
- Handoff assurance text: `d\471\解释\handoff-assurance\promoted_training_scale_seed_handoff_assurance.txt`
- Next batch command: `False`

## Command

```powershell
D:\python\python.exe scripts/plan_training_scale.py D:\aiproj\d\471\解释\source\corpus.txt --project-root D:\aiproj --out-dir D:\aiproj\d\471\解释\source\next-plan --batch-out-root D:\aiproj\d\471\解释\source\batch --dataset-name next-zh --dataset-version-prefix v82-test --suite-name standard-zh --max-variants 1
```
...
| Key | Exists | Path |
| --- | --- | --- |
| training_scale_plan_json | False | D:\aiproj\d\471\解释\source\next-plan\training_scale_plan.json |
| training_scale_variants_json | False | D:\aiproj\d\471\解释\source\next-plan\training_scale_variants.json |
| training_scale_plan_csv | False | D:\aiproj\d\471\解释\source\next-plan\training_scale_plan.csv |
| training_scale_plan_markdown | False | D:\aiproj\d\471\解释\source\next-plan\training_scale_plan.md |
| training_scale_plan_html | False | D:\aiproj\d\471\解释\source\next-plan\training_scale_plan.html |
