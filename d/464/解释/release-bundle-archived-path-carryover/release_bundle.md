...
- Generated: `2026-05-27T11:38:30Z`
...
| Field | Value |
| --- | --- |
| registry_path | d\461\解释\source-inputs\registry\registry.json |
| model_card_path | d\461\解释\source-inputs\model-card\model_card.json |
| project_audit_path | d\464\解释\project-audit-archived-path-carryover\project_audit.json |
| request_history_summary_path | d\461\解释\source-inputs\request-history-summary\request_history_summary.json |
| benchmark_history_path | d\461\解释\source-inputs\benchmark-history\benchmark_history.json |
| ci_workflow_hygiene_path | d\464\解释\ci-workflow-hygiene\ci_workflow_hygiene.json |
| test_coverage_report_path | d\461\解释\source-inputs\test-coverage\test_coverage_report.json |
...
- `d\461\解释\source-inputs\registry\registry.json`: yes, JSON, 730 bytes
- `d\461\解释\source-inputs\registry\registry.csv`: yes, CSV, 35 bytes
- `d\461\解释\source-inputs\registry\registry.svg`: no, SVG, missing
- `d\461\解释\source-inputs\registry\registry.html`: yes, HTML, 13 bytes
- `d\461\解释\source-inputs\model-card\model_card.json`: yes, JSON, 418 bytes
- `d\461\解释\source-inputs\model-card\model_card.md`: yes, MD, 12 bytes
- `d\461\解释\source-inputs\model-card\model_card.html`: yes, HTML, 13 bytes
- `d\464\解释\project-audit-archived-path-carryover\project_audit.json`: yes, JSON, 14,943 bytes
- `d\464\解释\project-audit-archived-path-carryover\project_audit.md`: yes, MD, 3,863 bytes
- `d\464\解释\project-audit-archived-path-carryover\project_audit.html`: yes, HTML, 8,369 bytes
- `d\461\解释\source-inputs\request-history-summary\request_history_summary.json`: yes, JSON, 414 bytes
...
- `d\461\解释\source-inputs\benchmark-history\benchmark_history.json`: yes, JSON, 1,106 bytes
...
- `d\464\解释\ci-workflow-hygiene\ci_workflow_hygiene.json`: yes, JSON, 19,763 bytes
- `d\464\解释\ci-workflow-hygiene\ci_workflow_hygiene.md`: yes, MD, 9,971 bytes
- `d\464\解释\ci-workflow-hygiene\ci_workflow_hygiene.html`: yes, HTML, 12,890 bytes
- `d\461\解释\source-inputs\test-coverage\test_coverage_report.json`: yes, JSON, 327 bytes
