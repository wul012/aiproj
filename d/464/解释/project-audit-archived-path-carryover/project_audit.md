...
- Generated: `2026-05-27T11:38:20Z`
- Registry: `d\461\解释\source-inputs\registry\registry.json`
- Model card: `d\461\解释\source-inputs\model-card\model_card.json`
- Request history summary: `d\461\解释\source-inputs\request-history-summary\request_history_summary.json`
- Benchmark history: `d\461\解释\source-inputs\benchmark-history\benchmark_history.json`
- CI workflow hygiene: `d\464\解释\ci-workflow-hygiene\ci_workflow_hygiene.json`
- Test coverage report: `d\461\解释\source-inputs\test-coverage\test_coverage_report.json`
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| #1 | v461-receipt-plan-carryover | ready | 0.8 | pass | 3 | pass (3 cases) | yes |
