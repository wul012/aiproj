...
| receipt_schema_version | summary_field | summary.receipt_schema_version | fail |
...
| --- | --- | --- | --- | --- | --- |
| summary_field | fail | 23 | 1 | 1 | ["summary.receipt_schema_version"] |
...
| --- | --- | --- | --- | --- |
| summary_field | summary_field | summary.receipt_schema_version | True | field differs from rebuilt summary |
...
| --- | --- | --- | --- | --- |
| text | sidecar_digest | d\460\解释\receipt-failure-smoke-wrapper\receipt-contract-failure-smoke\scenarios\tamper_summary_field\summary\promoted_training_scale_seed_handoff_receipt_contract_summary.txt | pass | True |
| markdown | sidecar_digest | d\460\解释\receipt-failure-smoke-wrapper\receipt-contract-failure-smoke\scenarios\tamper_summary_field\summary\promoted_training_scale_seed_handoff_receipt_contract_summary.md | pass | True |
| html | sidecar_digest | d\460\解释\receipt-failure-smoke-wrapper\receipt-contract-failure-smoke\scenarios\tamper_summary_field\summary\promoted_training_scale_seed_handoff_receipt_contract_summary.html | pass | True |
...
- summary.receipt_schema_version expected 4 but got 2
