...
| sidecar | fail | 3 | 1 | 1 | ["d\\460\\解释\\receipt-failure-smoke-wrapper\\receipt-contract-failure-smoke\\scenarios\\tamper_sidecar\\summary\\promoted_training_scale_seed_handoff_receipt_contract_summary.html"] |

## Failed Check Targets

| Family | Type | Target | Required | Detail |
| --- | --- | --- | --- | --- |
| sidecar | sidecar_digest | d\460\解释\receipt-failure-smoke-wrapper\receipt-contract-failure-smoke\scenarios\tamper_sidecar\summary\promoted_training_scale_seed_handoff_receipt_contract_summary.html | True | promoted_training_scale_seed_handoff_receipt_contract_summary.html content does not match rebuilt contract summary |
...
| --- | --- | --- | --- | --- |
| text | sidecar_digest | d\460\解释\receipt-failure-smoke-wrapper\receipt-contract-failure-smoke\scenarios\tamper_sidecar\summary\promoted_training_scale_seed_handoff_receipt_contract_summary.txt | pass | True |
| markdown | sidecar_digest | d\460\解释\receipt-failure-smoke-wrapper\receipt-contract-failure-smoke\scenarios\tamper_sidecar\summary\promoted_training_scale_seed_handoff_receipt_contract_summary.md | pass | True |
| html | sidecar_digest | d\460\解释\receipt-failure-smoke-wrapper\receipt-contract-failure-smoke\scenarios\tamper_sidecar\summary\promoted_training_scale_seed_handoff_receipt_contract_summary.html | fail | True |
